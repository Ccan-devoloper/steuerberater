...
assert(campus.includes('import "../data/k3-persg-tag3-register.js";'),"Tag-3-Register fehlt im gemeinsamen Campus"); assert(campus.includes("K3PersGTag3Visuals"),"Tag-3-Visuals fehlen"); assert(campus.includes("Tag 1 bis 4")&&campus.includes("captureRangesFor"),"gemeinsamer Campus bildet Tag 3 nicht mehr generisch ab"); assert(campus.includes("Quellenhinweis Einheitsfassung"),"Quellenhinweis fehlt in Modulen"); assert(campus.includes("Passende Originalfälle")&&campus.includes("Passende Lernmodule"),"Querverweise fehlen");
