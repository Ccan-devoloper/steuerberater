...
for(let s=1;s<=53;s+=1){assert(ao3Seitenplan[s],`AO Einheit 3: PDF-Seite ${s} fehlt.`);assert(byId.has(Number(ao3Seitenplan[s])),`AO Einheit 3: Seite ${s} verweist auf unbekannte ID.`);}
