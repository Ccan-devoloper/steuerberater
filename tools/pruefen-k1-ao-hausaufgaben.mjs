...
assert(k1AoHausaufgaben.length===3,'AO Hausaufgaben: Unterlagen 1.+2., 3. und 4. Fachtermin erwartet.');
...
assert(k1AoHausaufgaben.reduce((s,t)=>s+t.seiten,0)===33,'AO Hausaufgaben: Gesamtseitenzahl muss 33/33 betragen.');
assert(k1AoHausaufgaben.reduce((s,t)=>s+t.faelle.length,0)===10,'AO Hausaufgaben: insgesamt 10 Fälle erwartet.');
...
for(const id of [304,305,307,312,313,314,317,318,319,322,323,324,326,329,330,331,333,335,336,338,346,347,354,360,367,368,375,376,385,386])assert(AO_HAUSAUFGABEN_BY_MODULE.get(id)?.length,`AO Hausaufgaben: Modul-Rückverweis ${id} fehlt.`);

console.log('AO Hausaufgaben vollständig: 1.+2. Fachtermin 9/9 + 3. Fachtermin 11/11 + 4. Fachtermin 13/13 Seiten = 33/33 PDF-Seiten, 10 Fälle, aufklappbare Ergebnisse und bidirektionale Querverweise geprüft.');
