...
| **Bewertungsrecht Teil 3** (Schäfer, Oktober 2025), Drive-ID `1Nf9VVWSkEUHlhWm_y-mQ9XQaAbIKLWWa` | Zwei einzelne Musterlösungen: die **Lösung zu Beispiel 1** der Tz. 5 f (Schenkung eines Einzelunternehmens zum 1.6.2025), PDF-Seite 20/21, und die **Lösung zum ersten Beispiel der Tz. 6 c** (A+B OHG, gemeiner Wert 1.500.000 €, Kapitalkonten 150.000/250.000 €, Gewinnverteilung 20/80), PDF-Seite 26 | Die Datei ist im Übrigen vollständig lesbar. Beide Seiten tragen unter der Überschrift „Lösung:“ beziehungsweise „Lösung Beispiel 1:“ nur eine Grafik ohne Textebene; der Connector gibt dazu keinen Text aus. Die Sachverhalte beider Beispiele sind vollständig erfasst, so dass die Fälle selbständig gerechnet werden können. |
...
- **Bewertungsrecht Teil 3** (Schäfer, Stand Oktober 2025): Die Datei „2025) (6).pdf“
  ...
  Der Teil I ist inzwischen bis einschließlich Tz. 6 (Anteile am Betriebsvermögen einer
  Personengesellschaft) eingepflegt. Noch offen sind aus dem Teil I die Besonderheiten bei
  Kapitalgesellschaften (Tz. 7) sowie der gesamte Teil II (Gesonderte Feststellungen).
  Zwei einzelne Musterlösungen sind technisch blockiert, siehe Abschnitt A.
