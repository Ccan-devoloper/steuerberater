...
| **AO Teil V** (Jacobs, Mai 2025), Drive-ID `1WHbfjRVc8q5zyXiDhXXVptQ7izxyfanN` | Aus **Abschnitt 13** (Haftungsrecht) die Skriptseiten 53 bis 84 | Über den Datei-Download vollständig lesbar (175 PDF-Seiten); Abschnitt 12 ist nachgeholt, Abschnitt 13 bis Seite 52 eingepflegt, der Rest folgt. |
...
1. **Bisher blockierte Reste nachholen** (jetzt über den Download lesbar): ~~AO Teil I~~ (erledigt,
   ...
   (Abschnitt 12 erledigt; Abschnitt 13 ab Seite 53 offen), ESt-Kurzskript I (Seiten 80–162),
...
- **AO Teil V** („B-S25-AO-Teil V-(Jacobs)-0425 (1).pdf“, Drive-ID
  ...
  vollständig**. Aus dem **Abschnitt 13** (Haftungsrecht) sind die Seiten 1 bis 52 eingepflegt; der Rest steht in Abschnitt A.
