...
| **Bewertungsrecht Teil 3** (Schäfer, Oktober 2025), Drive-ID `1Nf9VVWSkEUHlhWm_y-mQ9XQaAbIKLWWa` | Drei einzelne Musterlösungen: die **Lösung zu Beispiel 1** der Tz. 5 f (Schenkung eines Einzelunternehmens zum 1.6.2025), PDF-Seite 20/21, die **Lösung zum ersten Beispiel der Tz. 6 c** (A+B OHG, gemeiner Wert 1.500.000 €, Kapitalkonten 150.000/250.000 €, Gewinnverteilung 20/80), PDF-Seite 26, und die **Lösung zu Beispiel 1 der Tz. 7 b** (Anteil an der A-GmbH, Nennkapital 100.000 €, Beteiligung 30 %, davon 80 % eingezahlt), PDF-Seite 29 | Die Datei ist im Übrigen vollständig lesbar. Alle drei Seiten tragen unter der Überschrift „Lösung:“ beziehungsweise „Lösung Beispiel 1:“ nur eine Grafik ohne Textebene; der Connector gibt dazu keinen Text aus. Die Sachverhalte beider Beispiele sind vollständig erfasst, so dass die Fälle selbständig gerechnet werden können. |
...
- **AO Teil V** („B-S25-AO-Teil V-(Jacobs)-0425 (1).pdf“, Drive-ID
  ...
  (DAC-7-Neuregelungen) eingepflegt – damit alles, was der Connector ausgibt. Offen ist,
  was hinter der Bruchstelle auf Seite 27 liegt; der **Abschnitt 13** wird vom Connector nicht mehr erreicht
  (siehe Abschnitt A).
...
- **Bewertungsrecht Teil 3** (Schäfer, Stand Oktober 2025): Die Datei „2025) (6).pdf“
  ...
  **Die Datei ist inzwischen vollständig eingepflegt** – der Teil I mit allen sieben
  Tz. und der Teil II mit den gesonderten Feststellungen nach §§ 151 bis 156 BewG.
  Offen bleiben nur drei einzelne Musterlösungen, die im PDF als Grafik ohne Textebene
  vorliegen, siehe Abschnitt A. Dazu kommt weiterhin die zugehörige Lösungsdatei
  „B-S25-ErbSt-Bewertung 2025-2026 Teil 3-Loesung“.
