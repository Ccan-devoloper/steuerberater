...
| **Steuerberaterprüfung 2022/2023 – amtliche Prüfungsaufgaben**, Drive-ID `1OIu1EKJ2j5uSv3egnNYjfCqKqDTWiw2h` (Dateititel „2026) (10).pdf“) | Die **Musterlösungen zu sämtlichen Teilen** – die Datei enthält ausschließlich Aufgabentexte. Noch nicht eingepflegt sind außerdem die Aufgabentexte des Ertragsteuer-Prüfungstags (ESt, GewSt mit 8 von 100 Punkten, KSt) und des Verfahrensrechts-Prüfungstags (AO/FGO, USt, ErbSt – Erbfall Schüssel) | Der Connector gibt das 0,5-MB-PDF vollständig aus (rund 82.000 Zeichen, 34 Seiten). Es sind die reinen Prüfungsaufgaben aller drei Prüfungstage ohne jede Lösung. Der Bilanz-Prüfungstag (vier Teile, 100 Wertungspunkte) steht im Reiter „Prüfungsklausuren im Original“. Eigene Feststellung: Ab dem Ertragsteuerteil trägt die Datei den Kopf „STEUERBERATERPRÜFUNG 2021/2022“, obwohl das Deckblatt 2022/2023 nennt. |
| **Steuerberaterprüfung 2021/2022 – amtliche Prüfungsaufgaben**, Drive-ID `1fD7j6QKx7MX2zt9gdlKZW7MFQe1UYtC3` | Die **Musterlösungen zu sämtlichen Teilen** – auch diese Datei enthält ausschließlich Aufgabentexte. Noch nicht eingepflegt sind außerdem aus dem Ertragsteuer-Prüfungstag die Teile **II (Gewerbesteuer)** und **III (Körperschaftsteuer)** sowie der gesamte Verfahrensrechts-Prüfungstag (AO/FGO, USt, ErbSt). Der Bilanz-Prüfungstag (Teil I Klaus Becker, Teil II Mutter-GmbH, Teil III Müller-OHG) und der Einkommensteuerteil mit seinen drei Sachverhalten (Anne T., Thomas S., Hanno P.) stehen in den Reitern „Prüfungsklausuren im Original“ des Bilanzen- bzw. des ESt-Campus | Der Connector gibt das 0,7-MB-PDF vollständig aus (rund 90.000 Zeichen, 34 Seiten). |
