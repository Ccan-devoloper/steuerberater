...
| **Steuerberaterprüfung 2021/2022 – amtliche Prüfungsaufgaben**, Drive-ID `1fD7j6QKx7MX2zt9gdlKZW7MFQe1UYtC3` | Die **Musterlösungen zu sämtlichen Teilen** – auch diese Datei enthält ausschließlich Aufgabentexte. Noch nicht eingepflegt sind außerdem die Aufgabentexte des Ertragsteuer-Prüfungstags (ESt, GewSt, KSt) und des Verfahrensrechts-Prüfungstags (AO/FGO, USt, ErbSt). Der Bilanz-Prüfungstag (Teil I Klaus Becker, Teil II Mutter-GmbH, Teil III Müller-OHG) steht im Reiter „Prüfungsklausuren im Original“ | Der Connector gibt das 0,7-MB-PDF vollständig aus (rund 90.000 Zeichen, 34 Seiten). |
