...
| **AO Teil IV** (Jacobs, Mai 2025), Drive-ID `177nsS17x67L6LjIOFiQ_t06vrtn4e9oA` | Nur noch der **Abschnitt 10** (vorläufiger Rechtsschutz, Skriptseiten 1 bis 34) | Über den Datei-Download vollständig lesbar (144 PDF-Seiten); Abschnitt 9 ist damit nachgeholt, Abschnitt 10 folgt als Nächstes. |
...
1. **Bisher blockierte Reste nachholen** (jetzt über den Download lesbar): ~~AO Teil I~~ (erledigt,
   ...
   (erledigt, vollständig), AO Teil IV (Abschnitt 9 erledigt; Abschnitt 10 offen), AO Teil V
...
- **AO Teil IV** („2025) (7).pdf“, Drive-ID `177nsS17x67L6LjIOFiQ_t06vrtn4e9oA`): Dieser
  ...
  nachgeholt). Offen ist nur noch Abschnitt 10; er steht in Abschnitt A.
