...
| **KSt-Kurz-Skript** (Breier, Mai 2026), Drive-ID `1y8gIRktpHe5VRBSIX8mTTVmQTypNQYY0` | **Inzwischen vollständig heruntergeladen (September 2026); Einpflege in Arbeit – Teile 4 und 5 vollständig erledigt.** Ab Seite 137 von 196: **Teil 6 (Verluste von Körperschaften), Teil 7 (Zinsschranke), Teil 8 (Organschaft), Teil 9 (Liquidation), Teil 10 (Nennkapital)** | Der Connector gibt das PDF nur bis etwa Seite 90 aus. Die Teile 1 bis 3 und der Anfang von Teil 4 sind lesbar und eingepflegt; ab der Bruchstelle fehlt auch der Rest von Teil 4. |
...
- KSt-Kurz-Skript (Breier): die Teile 1 bis 5 sind eingepflegt. Das
