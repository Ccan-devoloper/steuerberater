  ...
  for (const eintrag of beitraegeFaellig) {
    ...
    try {
      ...
      if (eintrag.format === "reel") {
        ...
        fertigeBeitraege.set(eintrag.slot, { ...reel, folien: [{ art: "titel", titel: reel.szenen[0]?.titel, icon: reel.szenen[0]?.icon }], kurztitel: reel.szenen[0]?.titel || reel.kurztitel });
