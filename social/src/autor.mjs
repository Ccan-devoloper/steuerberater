...
- bildSzene je Szene: eine ENGLISCHE Beschreibung einer konkreten Alltagsszene mit EINER Person oder EINEM Gegenstand, 3 bis 6 Wörter, nach denselben Regeln wie das Cover-Motiv unten. Sie wird als freigestellte Figur groß neben den Text gestellt.
  Entscheidend: Sie muss genau das zeigen, was DIESE Szene sagt – nicht das Thema allgemein. Prüfe jede Beschreibung mit der Gegenfrage „Würde jemand, der nur dieses Bild sieht und den gesprochenen Satz hört, beides zusammenbringen?“ Für „Der Mandant reicht zu spät ein“ also „person dropping letter into mailbox“, für „Das Finanzamt schätzt“ „official stamping a form at a desk“ – zwei verschiedene Bilder, weil zwei verschiedene Aussagen. Gib NICHT in allen Szenen dieselbe oder eine fast gleiche Beschreibung an; jede Szene bekommt ihr eigenes Bild.
  Keine Fachvokabeln, keine Symbolbild-Klassiker, keine Gruppen. Fällt dir für eine Szene nichts Konkretes ein, das wirklich zu ihrer Aussage passt: null. Dann übernimmt sie die Figur der vorherigen Szene, und das ist besser als ein Bild, das danebenliegt.
