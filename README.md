...
- **Bilanz-Skript Termin 1 (Melzer)** (Klausur 3, Campus Bilanzen → „Skript (Melzer)“): das
  ...
  **Kapitel 13 bis 16** (Schuldübernahme, Bewertungseinheiten, latente Steuern, Bilanzberichtigung) –
  vollständig; dazu als Anhang die **Übersichten** zum Skript, vollständig, alle 27 Abschnitte –
  zusammen 96 Einträge, 2832 Blöcke, 237 Tabellen. Prüfung: `npm run check:k3-bil-skript-melzer`
