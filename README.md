...
- **IStR-Skript (Grümmer/Holzrichter)** (Klausur 2, Campus IStR → „Skript (Grümmer/Holzrichter)“):
  ...
  Wortlaut, die Schaubilder als Tabellen. Eingepflegt sind **Kapitel 1 bis 4** (Einleitung,
  Definition, Arten der Steuerpflicht mit §§ 1, 1a, 49, 50, 50a EStG, Doppelbesteuerung mit
  OECD-MA Art. 1 bis 32, Übungsfällen und Steueranrechnung nach § 34c EStG) – 64 Abschnitte,
  951 Blöcke, 25 Tabellen. Kapitel 5 und 6 und die DBA-Texte folgen. Prüfung: `npm run check:k2-istr-skript-gh`
...
- **ESt-Originalklausuren** (Klausur 2, Reiter Einkommensteuer → „Originalklausuren
  ...
  **doppelt begrenzt** auf die nach Art. 10 Abs. 2 Buchst. b DBA-Österreich zulässigen 15 %
  ...
  Aus der **Prüfung 2014** (Teil I: Einkommensteuer, drei Sachverhalte; Punkte laut Korrekturbogen): **Sachverhalt 1 (José S., 18 Punkte)** – Wegzug nach Brasilien mitten im Jahr: Wechsel
...
- **USt-Skript (Moecker)** (Klausur 1, Reiter Umsatzsteuer → „USt-Skript (Moecker)“): das
  ...
  Reiseleistung / Differenzbesteuerung / Kleinunternehmer & Steuersatz) vollständig mit
  ...
  Block 12 (Berichtigung des Vorsteuerabzugs nach § 15a UStG) vollständig mit Inhaltsverzeichnis,
