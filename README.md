...
- **Bilanz-Skript Termin 1 (Melzer)** (Klausur 3, Campus Bilanzen → „Skript (Melzer)“): das
  ...
  **Kapitel 13 bis 16** (Schuldübernahme, Bewertungseinheiten, latente Steuern, Bilanzberichtigung) –
  vollständig; dazu als Anhang die **Übersichten** zum Skript, bisher Abschnitte 1 bis 21 (von 27) –
  zusammen 90 Einträge, 2649 Blöcke, 203 Tabellen. Prüfung: `npm run check:k3-bil-skript-melzer`
