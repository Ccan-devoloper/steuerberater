...
- **USt-Skript (Moecker)** (Klausur 1, Reiter Umsatzsteuer → „USt-Skript (Moecker)“): das
  ...
  A 27 ebenfalls vollständig, Block 4 (Entgeltliche Lieferungen) bis V mit 8 Kapiteln
  eingepflegt.
  ...
  unbewegte Lieferung mit 4-W-Fragen und Kauf auf Probe) und der Ortsverlagerung nach § 3 Abs. 8
  UStG.
