...
- **USt-Skript (Moecker)** (Klausur 1, Reiter Umsatzsteuer → „USt-Skript (Moecker)“): das
  ...
  unentgeltlichen sonstigen Leistungen samt BMG, der privaten Fahrzeugnutzung, der Mindest-BMG und den Leistungen an Arbeitnehmer (Textteil vollständig) und den Arbeitspapieren A 1 bis A 8 (29 Kapitel).
