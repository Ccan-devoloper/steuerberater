...
- **Bilanz-Skript Termin 1 (Melzer)** (Klausur 3, Campus Bilanzen → „Skript (Melzer)“): das
  ...
  **Kapitel 6** (nicht abnutzbares Anlagevermögen), **Kapitel 7** (Umlaufvermögen), **Kapitel 8**
  (Forderungen), **Kapitel 9** (Rechnungsabgrenzung) und **Kapitel 10** (Verbindlichkeiten) –
  39 Abschnitte, 1672 Blöcke, 84 Tabellen. Die Kapitel 11 bis 16 folgen. Prüfung: `npm run check:k3-bil-skript-melzer`
