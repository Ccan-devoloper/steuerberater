      ...
      <main className="page">
        ...
        {verlauf.ansicht === "kurzskript" && (
          <KurzskriptBloecke
            ...
            lead="Das Kurz-Skript von Ulrich Breier (Stand 04/2025, ohne § 24 UmwStG) im Wortlaut. Eingepflegt sind Teil 1 (Überblick über das Umwandlungssteuerrecht mit Umwandlungssteuererlass), Teil 2 (zivilrechtliche Grundlagen: Verschmelzung, Formwechsel, Spaltung, Einzelrechtsnachfolge und Anwachsung), Teil 3 (Verschmelzung/Formwechsel einer Kapitalgesellschaft auf ein Personenunternehmen mit Übernahmeergebnis, Rückoption nach § 1a KStG und Gewerbesteuer), Teil 4 (Verschmelzung von Kapitalgesellschaften nach §§ 11 – 13 UmwStG einschließlich Organgesellschaft und Einlagekonto) und Teil 5 (Spaltung von Kapitalgesellschaften nach §§ 15, 16 UmwStG). Teil 6 (Einlage und Einbringung) folgt."
