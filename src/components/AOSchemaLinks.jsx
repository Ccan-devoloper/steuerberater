...
const ZIELE = [
  ...
  [/§\s*(?:249|251|254|220|259|281|286|263|295)\b/i, "ao-schema-vollstreckung"],
  [/§§?\s*(?:33|35|38|40|41|44|45|46|47|54|57|58|62|63)\s*FGO\b/i, "ao-schema-fgo"],
  [/§\s*173a\b/i, "ao-schema-173a"],
  [/§\s*173\s*Abs\.\s*1\s*Nr\.\s*[12]\b|AEAO\s+zu\s+§\s*173/i, "ao-schema-173"],
