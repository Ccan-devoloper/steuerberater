    ...
    <div className="kst-campus istr2-campus">
      ...
      <main className="page">
        ...
        {verlauf.ansicht === "skript-gh" && <KurzskriptBloecke
          ...
          lead="Das Lehrgangsskript von Dieter Grümmer und Daniela Holzrichter (März 2026, Rechtsstand 2025) im Wortlaut, die Schaubilder als Tabellen. Eingepflegt sind Kapitel 1 und 2 (Einleitung, Definition) und Kapitel 3 (Arten der Steuerpflicht: unbeschränkte Steuerpflicht, §§ 1 Abs. 3, 1a EStG, beschränkte Steuerpflicht mit § 49 EStG, Veranlagung nach § 50 EStG und Steuerabzug nach § 50a EStG) und Kapitel 4 (Doppelbesteuerung, Rechtsnatur der DBA, OECD-MA Art. 1 bis 32 mit Betriebstätte, Entstrickung, Dividenden, Arbeitslohn, Freistellung mit Progressionsvorbehalt, Anrechnung und fünf Übungsfällen sowie die Steueranrechnung nach § 34c EStG und § 26 KStG) und Kapitel 5 (Sondernormen: ausländische Verluste nach § 2a EStG, Einkünfteberichtigung nach § 1 AStG und Wegzugsbesteuerung nach § 6 AStG). Kapitel 6 (Zusätzliche Materialien: §§ 2–5 AStG, Zwischengesellschaften, Familienstiftungen) und die DBA-Texte folgen."
