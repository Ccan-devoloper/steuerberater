...
const ziele = [
  ...
  { id: "schema-vorsteuer", label: "VI. Vorsteuer", patterns: [/§\s*15(?!a)\b/i, /Vorsteuer/i, /Einfuhrumsatzsteuer/i] },
  ...
  { id: "schema-bmg", label: "IV. BMG", patterns: [/§\s*10\b/i, /§\s*11\b/i, /Bemessungsgrundlage/i, /Entgelt/i, /Zollwert/i] },
  ...
  { id: "schema-befreiung", label: "II. Befreiung", patterns: [/§§\s*4\s*[–-]\s*9/i, /§\s*4\b/i, /§\s*6\b/i, /§\s*7\b/i, /Steuerbefreiung/i, /steuerfrei/i, /Ausfuhrlieferung/i, /Lohnveredelung/i] },
  ...
  { id: "schema-ort-lieferung", label: "Ort Lieferung", patterns: [/§\s*3c\b/i, /§\s*3e\b/i, /§\s*3g\b/i, /§\s*3\s*Abs\.\s*(?:5a|6a?|7|8)\b/i, /bewegte Lieferung/i, /ruhende Lieferung/i, /Lieferort/i, /Reihengeschäft/i] },
  { id: "schema-leistungsart", label: "I.1 Leistungsart", patterns: [/§\s*3\s*Abs\.\s*(?:1|1a|1b|3|4|6a|9|9a|12)\b/i, /Werklieferung/i, /Werkleistung/i, /Hauptleistung/i, /Nebenleistung/i, /Lieferung/i, /sonstige Leistung/i, /Tausch/i, /Reihengeschäft/i] },
  ...
  { id: "schema-steuerbarkeit", label: "I. Steuerbarkeit", patterns: [/§\s*1\b/i, /Steuerbarkeit/i, /steuerbar/i, /nicht steuerbar/i, /gegen Entgelt/i, /Einfuhr(?:umsatzsteuer)?/i] },
];
