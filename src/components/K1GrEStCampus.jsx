...
const OFFEN = [
  "IV. Steuerbefreiungen und Steuervergünstigungen – der Rest des Abschnitts: die Ausnahmen bei Ergänzungstatbeständen (§ 3 GrEStG), § 4 GrEStG, die Erwerbsvorgänge zwischen Gesamthändern (§§ 5, 6 GrEStG) und die konzerninterne Umstrukturierung (§ 6a GrEStG)",
