      ...
      <main className="page">
        {verlauf.ansicht === "kurzskript" ? (
          ...
          <HausaufgabenBloecke
            ...
            lead="Der Gewerbesteuerteil des zweiten Prüfungstages im amtlichen Wortlaut – kein fortgeschriebener Rechtsstand, keine Bearbeitung, die Jahreszahlen des Originaljahrgangs. Eingepflegt sind die Prüfungen **2021/2022** (Erhebungszeitraum 2020, ohne Punkteangabe in der Quelle) und **2022/2023** (Erhebungszeitraum 2021, 8 von 100 Wertungspunkten). **Zu dieser Aufgabe enthält die Quelle keine Lösung**, und es wird hier ausdrücklich keine erfunden; der Eintrag sagt das offen, hält fest, was die Aufgabenstellung selbst vorgibt, und verweist auf die Stellen im Campus, an denen dieselben Rechtsfragen mit vollständiger Musterlösung stehen. Die MAX-OHG führt Baustoffgroßhandel und Baumaschinenverleih als getrennte Geschäftseinheiten mit eigenen Räumen, eigener Belegschaft und eigener Buchhaltung – und an nur einem der beiden Zweige ist eine Dritte still beteiligt, die zugleich als Prokuristin angestellt ist. Sämtliche Merkmale ihrer Beteiligung sind einzeln aufgezählt: 20 % an Gewinn und Verlust, Beteiligung an den stillen Reserven, Kontrollrechte nach § 716 BGB, Widerspruchsrecht bei außergewöhnlichen Geschäften. Ob daraus ein Gewerbesteuermessbetrag wird oder zwei, entscheidet die ganze Aufgabe – und die Aufgabenstellung fragt selbst nach „dem bzw. den“ Messbeträgen. Der Jahrgang 2022/2023 setzt genau umgekehrt an: Dort ist die Gewerbesteuerpflicht ausdrücklich **nicht** zu prüfen, dafür sind Messbetrag und vortragsfähiger Gewerbeverlust zu ermitteln. Bei der Elektro-OHG wechseln in einem einzigen Jahr drei von vier Gesellschaftern – einer überträgt am 1. Januar unentgeltlich auf seinen Sohn, zwei veräußern am 31. Dezember an denselben Erwerber –, während ein festgestellter Gewerbeverlust von 200.000 € einem laufenden Gewinn von nur 80.000 € gegenübersteht. Dazu vier Aufwandspositionen, die auf § 8 Nr. 1 GewStG zielen, darunter Miete für Hochregale in einer gemieteten Lagerhalle und für Lastkraftwagen, die ausdrücklich reine Elektrofahrzeuge sind."
