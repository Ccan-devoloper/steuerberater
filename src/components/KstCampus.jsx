      ...
      <main className="page">
        ...
        {ansicht === "teil1" && (
          <KurzskriptBloecke
            ...
            lead="Das Lehrgangsskript „Körperschaftsteuer, Teil I“ von Hamacher (Stand 04/2026) im Wortlaut. Es beginnt mit dem Satz, der die ganze Systematik trägt: Die Körperschaftsteuer ist vereinfachend die „Einkommensteuer der Kapitalgesellschaften“ – das KStG enthält nur die Spezialregelungen, alles Übrige holt § 8 Abs. 1 Satz 1 KStG aus dem EStG. **Das Kapitel 1 (Steuerpflicht) ist vollständig eingepflegt**: die unbeschränkte Steuerpflicht mit Typenvergleich, britischer Limited nach dem Brexit und optierender Gesellschaft; die beschränkte Steuerpflicht in ihren zwei Spielarten, darunter die des § 2 Nr. 2 KStG für juristische Personen des öffentlichen Rechts; Beginn und Ende der Steuerpflicht mit der Unterscheidung von Vorgründungsgesellschaft, Vorgesellschaft und eingetragener Kapitalgesellschaft; die Steuerbefreiungen des § 5 KStG mit der Gemeinnützigkeit, der Geprägetheorie und der Freigrenze des § 64 Abs. 3 AO; sowie die Option nach § 1a KStG mit ihren Folgen für den Mitunternehmer, der zum Anteilseigner wird. Auch das **Kapitel 2 (Einkommensermittlung)** ist vollständig: die Bemessungsgrundlage mit dem abweichenden Wirtschaftsjahr, die Brückenvorschrift des § 8 Abs. 1 Satz 1 KStG, die zweistufige Einkommensermittlung, das Berechnungsschema mit der Rückrechnung vom Bilanzgewinn auf den Jahresüberschuss, die außerbilanziell herauszunehmenden „steuerfreien“ Erträge, die nicht abziehbaren Ausgaben des § 4 Abs. 5 EStG samt ihrer umsatzsteuerlichen Folge, das Abzugsverbot für Personensteuern nach § 10 Nr. 2 KStG mit der Besonderheit bei den Zinsen des § 233a AO, die hälftige Hinzurechnung der Aufsichtsratsvergütungen nach § 10 Nr. 4 KStG, der Spendenabzug mit seinen beiden Höchstbeträgen und dem Spendenvortrag sowie der Verlustabzug mit Rücktrag in zwei Jahre und der Mindestbesteuerung beim Vortrag. Aus dem **Kapitel 3 (verdeckte Einlage)** sind die Abschnitte 3.1 bis 3.2.4 eingepflegt: die Begriffsdefinition, die das Gesetz gerade nicht liefert, der Gegensatz zur verdeckten Gewinnausschüttung, die Rolle der Buchung für die Einkommenskorrektur und die beiden Fallgruppen Vermögensmehrung und verhinderte Vermögensminderung mit drei Beispielen; dann die gesellschaftsrechtliche Veranlassung mit dem Fremdvergleich, der einlagefähige Vermögensvorteil – auch immaterielle Wirtschaftsgüter und konkretisierte Geschäftschancen zählen dazu, die bloße Nutzungsüberlassung dagegen nie, weshalb ein zinsloses Gesellschafterdarlehen keine verdeckte Einlage ist – dann die Zurechnung, in der die disquotale Einlage ertragsteuerlich allein dem Einlegenden zugerechnet wird, während § 7 Abs. 8 Satz 1 ErbStG die reflexartige Wertsteigerung beim Mitgesellschafter schenkungsteuerlich dennoch erfasst, samt der mittelbaren verdeckten Einlage durch nahestehende Personen und der Beteiligungskette, in der die Einlage Stufe für Stufe durchgeleitet wird; und schließlich die **vollständige Bewertung**: der Teilwert als Grundsatz, die Drei-Jahres-Regelung des § 6 Abs. 1 Nr. 5 Buchstabe a EStG, die nur für Einlagen aus dem Privatvermögen gilt und auch dort nicht, wenn die Einlage beim Gesellschafter schon § 23 Abs. 1 Satz 5 Nr. 2 EStG auslöst, sowie die Einlage einer Beteiligung, bei der weder Buchstabe b noch Buchstabe c anwendbar ist. Von den **Anwendungsfällen des Abschnitts 3.4** sind die ersten drei da: die verbilligte oder unentgeltliche Übertragung von Wirtschaftsgütern mit ihren umsatzsteuerlichen und grunderwerbsteuerlichen Folgen, die überteuerte Lieferung an den Gesellschafter, bei der die verdeckte Einlage netto rechnet und die Umsatzsteuer auf dem vollen vereinbarten Entgelt bleibt, und die Übernahme einer Verbindlichkeit, die nur dann verhinderte Vermögensminderung ist, wenn der Gesellschafter zugleich auf den Rückforderungsanspruch verzichtet. Dazu die beiden Anwendungsfälle, die jede KSt-Klausur kennt: der **Forderungsverzicht**, bei dem die verdeckte Einlage nur den werthaltigen Teil erfasst und ein Teilverzicht nach dem BFH zuerst den wertlosen Teil aufzehrt – wer anteilig aufteilt, rechnet an der Rechtsprechung vorbei –, und der **Verzicht gegen Besserungsschein**, der im Verzichtszeitpunkt wie jeder andere Verzicht behandelt wird und bei Eintritt des Besserungsfalles vollständig „zurückgedreht“ wird, bis hin zum Einlagekonto, das dabei negativ werden darf. Ein durchgerechneter Fall über vier Veranlagungszeiträume stellt Gesellschaft und Gesellschafter nebeneinander. Dazu der vollständige **Exkurs zum Gesellschafterdarlehen mit Rangrücktritt**: die zivilrechtlichen Grundlagen von einfachem und qualifiziertem Rangrücktritt – eine Unterscheidung, die seit § 19 Abs. 2 InsO insolvenzrechtlich kaum noch trägt – und die steuerlichen Rechtsfolgen, die allein an der Tilgungsabrede hängen. Fehlt der Bezug auf das freie Vermögen, greift das Passivierungsverbot des § 5 Abs. 2a EStG, die Verbindlichkeit wird erfolgswirksam ausgebucht, in Höhe des werthaltigen Teils liegt eine verdeckte Einlage vor und spätere Zinsen werden zur verdeckten Gewinnausschüttung. Vom Abschnitt **3.5 (Auswirkungen der verdeckten Einlage)** sind die Folgen bei der Gesellschaft da – Einkommenskorrektur und Zugang beim Einlagekonto, die sachlich unabhängig voneinander sind und zeitlich auseinanderfallen können – sowie beim Gesellschafter die nachträglichen Anschaffungskosten mit ihren drei Rechtsgrundlagen und die **Zuflussfiktion**: Der Sachverhalt wird so behandelt, als hätte der Gesellschafter zuerst sein angemessenes Entgelt erhalten und es dann sofort wieder eingelegt, weshalb sich der Zufluss durch eine verdeckte Einlage nicht unterdrücken lässt. Bei der mittelbaren Einlage bleibt die Besteuerung des Anspruchs bei dem, der ihn hatte, während beim Wirtschaftsgut des Privatvermögens die Rechtsnachfolge des § 23 Abs. 1 Satz 3 EStG greift. Dazu der **Forderungsverzicht beim Anteilseigner**, dessen Schicksal von Rechtsform und Vermögenszugehörigkeit abhängt: Im Privatvermögen greift § 20 Abs. 2 Nr. 7 EStG, seit der rückwirkenden Aufhebung des § 20 Abs. 6 Satz 6 EStG a. F. ohne besondere Beschränkung – aber nur, soweit nicht § 17 Abs. 2a Satz 3 Nr. 2 EStG nachträgliche Anschaffungskosten begründet, was den Verlust in Zeitpunkt und Einkunftsart verschiebt. Im Betriebsvermögen entscheidet § 3c Abs. 2 Satz 2 EStG: Ab einer Beteiligung von mehr als 25 % zu irgendeinem Zeitpunkt der Darlehenslaufzeit greift das Teilabzugsverbot, bei einer darlehensgebenden Personengesellschaft für jeden Mitunternehmer gesondert. Bei einer Anteilseigner-Kapitalgesellschaft tritt an die Stelle des § 3c Abs. 2 EStG das vollständige Abzugsverbot des § 8b Abs. 3 Sätze 4 bis 9 KStG. Und schließlich die **Aufwendungen bei Nutzungsvorteilen**: Der Nutzungsvorteil ist zwar keine verdeckte Einlage, folgenlos bleibt er beim Gesellschafter aber nicht – seine Aufwendungen wechseln den Veranlassungszusammenhang und unterliegen nach § 3c Abs. 2 Satz 6 EStG dem Teilabzugsverbot. Bei der **überquotalen Nutzungseinlage** wird zweistufig gekürzt: erst der Quotenüberhang nach Entnahmegrundsätzen, dann das Teilabzugsverbot auf den Rest – beim Mitgesellschafter ist nichts abziehbar, weil es Drittaufwand ist. Vom **Korrespondenzprinzip (3.6)** ist die materielle Korrespondenz vollständig da: Der Abzug der verdeckten Einlage bei der Gesellschaft hängt davon ab, ob der Vorgang beim Anteilseigner erfasst wurde – ist dessen Einkommen gemindert, wird der Schaden bei der Gesellschaft nachversteuert, während das Einlagekonto davon unberührt bleibt. Die **Soweit-Verknüpfung** begrenzt die Hinzurechnung auf den Betrag, um den das *steuerpflichtige* Einkommen des Anteilseigners höher gewesen wäre – bei einer Anteilseigner-Kapitalgesellschaft mit steuerfreiem Gewinn nach § 8b Abs. 2 KStG entfällt sie deshalb ganz. Vier durchgerechnete Fälle zeigen die Abstufung. Die **formelle Korrespondenz** des § 32a Abs. 2 KStG ergänzt das verfahrensrechtlich: Wird der Bescheid des Anteilseigners später korrigiert, darf der Körperschaftsteuerbescheid geändert werden – unabhängig von Bestandskraft und Verjährung, mit eigener Ablaufhemmung von einem Jahr, aber ohne Grundlagenbescheidwirkung. Vom **Ausgangsvermögen (3.7)** ist der Grundsatz da, der den ganzen Abschnitt trägt: Maßgebend ist die Vermögenszugehörigkeit der **Beteiligung**, nicht die des eingelegten Wirtschaftsguts – liegt dieses im Betriebsvermögen, geht der Einlage deshalb eine Zwangsentnahme voraus, die alle stillen Reserven aufdeckt und die Ersatzrealisationstatbestände danach ins Leere laufen lässt. Bei **teilentgeltlicher Übertragung** spaltet die Trennungstheorie den Vorgang nach dem Verhältnis von Kaufpreis zu Verkehrswert in ein voll entgeltliches und ein voll unentgeltliches Geschäft – die Summe der beiden Gewinne bleibt dabei immer die Summe der stillen Reserven, was die schnellste Kontrolle in der Klausur ist. Liegen Beteiligung **und** Wirtschaftsgut im Betriebsvermögen, bleibt dagegen alles dort: ein Aktivtausch mit Ertrag, ohne Entnahme, mit Vollaufdeckung der stillen Reserven – und ohne die Möglichkeit des § 6b EStG, weil es an einem Entgelt fehlt. Liegt umgekehrt die Beteiligung im Betriebsvermögen und das Wirtschaftsgut im Privatvermögen, geht eine **Zwangseinlage** voraus – und deren Bewertung entscheidet über alles Weitere: Wird mit dem Teilwert eingelegt, bleiben die stillen Reserven im Privatvermögen und werden nach § 23 EStG besteuert; greift dagegen die Drei-Jahres-Regelung, wandern sie in das Betriebsvermögen und unterliegen dort zusätzlich der Gewerbesteuer. Bei einer Kapitalgesellschaft als Anteilseigner entfällt die Frage, weil sie kein Privatvermögen hat. Eine Übersicht ordnet alle fünf Konstellationen. Damit ist auch die **Schenkungsteuer (3.8)** da, die systematisch ganz anders funktioniert als das Ertragsteuerrecht: Beim Alleingesellschafter passiert nichts, bei mehreren Gesellschaftern fingiert § 7 Abs. 8 Satz 1 ErbStG dagegen eine Zuwendung – ohne Zuwendungswillen, bemessen nach der Werterhöhung der fremden Anteile statt nach dem Teilwert, und sogar bei der Nutzungseinlage, die ertragsteuerlich gar keine verdeckte Einlage ist. Und schließlich das **Verhältnis zu § 1 AStG (3.9)**: Beide Normen stehen rechtlich nebeneinander, praktisch bleibt für das AStG aber nur Raum, wo die verdeckte Einlage nicht greift oder zu niedrig bewertet. Nur noch das Kapitel 4 (Ermittlung der Körperschaftsteuer) folgt nach demselben Verfahren."
