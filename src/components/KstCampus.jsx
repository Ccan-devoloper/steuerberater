...
import { kstTeil6, kstTeil6Quelle } from "../data/k2-kst-teil6-hamacher.js";
...
const ansichten = [
  ...
  { id: "teil6", label: "Teil VI (Organschaft)", Icon: IconRegister },
    ...
    <div className="kst-campus">
      ...
      <main className="page">
        ...
        {ansicht === "teil6" && (
          <KurzskriptBloecke
            kicker="Klausur 2 · Körperschaftsteuer · Lehrgangsunterlage"
            titel="KSt Teil VI – Organschaft (Hamacher)"
            lead="Das Lehrgangsskript „Körperschaftsteuer, Teil VI: Körperschaft- und gewerbesteuerliche Organschaft (§§ 14 – 19 KStG; § 2 Abs. 2 Satz 2 GewStG)“ von Hamacher (21. Auflage, Rechtsstand 05/2025) im Wortlaut – **in Arbeit**. Die Organschaft hebt die **Trennung der Rechtssphären** auf: Sämtliche Steuerfolgen verlagern sich auf den **Organträger**, weil der Gewinn nach § 301 AktG tatsächlich abgeführt und der Verlust nach § 302 AktG tatsächlich ausgeglichen wird – die Zurechnung folgt also dem **Geld**, weshalb die tatsächliche Durchführung des Vertrags eine eigene Tatbestandsvoraussetzung ist. Die **gewerbesteuerliche** Organschaft folgt der körperschaftsteuerlichen **automatisch** (§ 2 Abs. 2 Satz 2 GewStG), die **umsatzsteuerliche** ist dagegen eigenständig: Sie verlangt zusätzlich wirtschaftliche und organisatorische Eingliederung, verzichtet aber auf den Gewinnabführungsvertrag – beide können unabhängig voneinander vorliegen. Geprüft wird in **fünf Schritten**: Organgesellschaft, Organträger mit deutschem Besteuerungsrecht, finanzielle Eingliederung, formwirksamer Vertrag mit fünfjähriger Mindestlaufzeit und dessen tatsächliche Durchführung. **Organgesellschaft** kann nur eine **Kapitalgesellschaft** sein – AG, KGaA und SE unmittelbar, GmbH und UG über § 17 KStG, nach den BFH-Entscheidungen vom 11.12.2024 auch eine Gesellschaft mit **atypisch stiller** Beteiligung. Verlangt sind **Geschäftsleitung im Inland** und **Sitz im EU-/EWR-Raum**: Die Drittstaatengesellschaft ist auch bei inländischer Geschäftsleitung ausgeschlossen, die „Organschaft über die Grenze“ scheitert am fehlenden Inlandsbezug. Die nach § 1a KStG **optierende** Gesellschaft scheidet aus rein zivilrechtlichem Grund aus – für sie gibt es keinen eintragungsfähigen Gewinnabführungsvertrag –, kann aber sehr wohl **Organträgerin** sein. **Organträger** kann jedes **gewerbliche** Unternehmen sein – rechtsformunabhängig, denn der Grund des Merkmals ist, dass sich die Gewerbesteuerpflicht der Organgesellschaft beim Organträger **fortsetzt**. Deshalb scheiden Freiberufler und Land- und Forstwirte aus, während bei der Kapitalgesellschaft die Rechtsform genügt, auch bei dauerdefizitärer oder vermögensverwaltender Tätigkeit. Eine Befreiung nach **§ 3 GewStG** greift **nicht durch**: Das eigene Ergebnis bleibt steuerfrei, der zugerechnete Gewerbeertrag steuerpflichtig – anders als die persönliche Befreiung nach § 5 KStG, die schon den Organträger ausschließt. Die gewerbliche Tätigkeit muss nicht ununterbrochen bestehen, sondern erst bei **Entstehung des Abführungsanspruchs**. Die **Personengesellschaft** muss eine **originär** gewerbliche Tätigkeit von **substanzieller Bedeutung** ausüben – eine Verschärfung, die genau auf die alte **Willensbildungsgesellschaft** der Mehrmütterorganschaft zielt. Ausreichend sind tatsächliche Betätigungen (Besitzgesellschaft einer Betriebsaufspaltung, entgeltliche Dienstleistungen, **geschäftsleitende Holding**), nicht dagegen die bloß **fingierte** Gewerblichkeit durch **Prägung** oder **Abfärbung** – letztere auch oberhalb der Bagatellgrenze nicht. Im Beispiel reichen 1.000 € neben 1.000.000 € Beteiligungsergebnis nicht aus. Beim **Organträger** kommt es auf **Sitz und Geschäftsleitung gar nicht an** – er darf sogar in einem **Drittstaat** ansässig sein; den Inlandsbezug stellt allein die **Beteiligung** her, die ununterbrochen einer inländischen Betriebsstätte zuzuordnen ist. In DBA-Fällen gilt dabei **Art. 5 OECD-MA**, was gerade die **Besitzpersonengesellschaft** einer Betriebsaufspaltung trifft: national gewerblich, abkommensrechtlich aber keine Betriebsstätte. Die **finanzielle Eingliederung** verlangt die **Stimmrechts**mehrheit, nicht die nominelle Beteiligung: Mehrfachstimmrechte helfen, eine im Vertrag vorgesehene **qualifizierte** Mehrheit muss erreicht werden, und ein bloßer **Stimmrechtsbindungsvertrag** genügt nicht, weil das wirtschaftliche Eigentum fehlt – ein auffälliger Gegensatz zu § 8c KStG, wo dieselbe Bindung schädlich ist. **Mittelbare** Anteile zählen nur doppelt bedingt: Die vermittelnde Gesellschaft muss **beherrscht** werden (mehr als 50 %), und die Quote wird **durchgerechnet** – bei genau 50 % fällt die gesamte mittelbare Beteiligung weg, obwohl sie rechnerisch zur Mehrheit geführt hätte. Die Zwischengesellschaft muss **nicht organschaftsfähig** sein; auch eine ausländische Gesellschaft genügt. Eine rein mittelbare Beteiligung reicht aus, der Vertrag wird gleichwohl unmittelbar geschlossen. Bei der **Personengesellschaft** müssen die Anteile im **Gesamthandsvermögen** liegen; **Sonderbetriebsvermögen** bleibt ausgeblendet – dieselbe Stoßrichtung wie beim Erfordernis der originär gewerblichen Tätigkeit. **Zeitlich** muss die Eingliederung **vom Beginn des Wirtschaftsjahres an ununterbrochen** bestehen. Ein **Rückbezug** ist ausgeschlossen, weil die Eingliederung ein **tatsächlicher Lebenssachverhalt** ist – anders bei umwandlungsbedingter **Rechtsnachfolge** (§ 21 UmwStG, Verschmelzung), wo die **Vorbesitzzeit** übergeht, und bei der **Sachgründung**, weil dort keine fremde Beherrschung übersprungen wird. Die Einbringung in eine **bestehende** Gesellschaft hilft dagegen nicht. Die praktische Lösung ist die **Umstellung des Wirtschaftsjahres**: Ein Rumpf-Wj. ab dem Erwerbstag lässt die Eingliederung von Anfang an bestehen – im Jahr der Begründung sogar **zweimal**, erst auf den Erwerbstag, dann auf den Stichtag des Organkreises; die Zustimmung nach § 7 Abs. 4 Satz 3 KStG ist zu erteilen. Bei einer Veräußerung **zum Ende** des Wirtschaftsjahres schneidet R 14.4 Abs. 2 KStR den Übergang zwischen 24:00 und 00:00 Uhr, so dass **beide** Organschaften bestehen. Für die **Folgejahre** hat sich die Lage entscheidend gebessert: Die Eingliederung ist ein **zeitpunktbezogenes** Merkmal – fehlt sie in einem Jahr, entfällt nur dieses, und die Organschaft lebt danach wieder auf, sofern der Vertrag durchgehend **tatsächlich durchgeführt** wird. Der **Gewinnabführungsvertrag** verpflichtet **beide** Seiten: die Organgesellschaft zur Abführung ihres **handelsbilanziellen** Ergebnisses, den Organträger zum Ausgleich ihrer handelsbilanziellen Verluste. Weil zugerechnet aber das **steuerliche** Einkommen wird, entstehen aus dieser Abweichung die Mehr- und Minderabführungen. Der Vertrag wird erst mit der **Handelsregistereintragung** wirksam – **konstitutiv**, nicht deklaratorisch –, so dass die Dauer des Registerverfahrens über den Beginn der Organschaft entscheidet; nur bei der **eingegliederten AG** genügt der schriftliche Abschluss. Bei der **GmbH** gelten die aktienrechtlichen Vorschriften über § 17 KStG entsprechend, ergänzt um **notarielle Beurkundung** und den **dynamischen Verweis** auf § 302 AktG – nötig nur dort, weil das Gesetz die Verlustübernahme bei der AG selbst anordnet. Beim **ausländischen** Vertrag laufen zwei Prüfungen nebeneinander: inhaltlich am **deutschen** Maßstab (§ 291 AktG samt Verlustübernahme), formal am **ausländischen** Recht samt Eintragungspflicht – beides muss zusammentreffen, und die Organschaft beginnt erst mit der dortigen Eintragung. Die EU-Kommission hat dazu ein **Vertragsverletzungsverfahren** eingeleitet. Die **Mindestlaufzeit** von fünf Zeitjahren beginnt erst, wenn **sämtliche** Voraussetzungen erstmals erfüllt sind. Daraus folgt die wichtigste Vertragsklausel überhaupt: Ein **festes Enddatum** lässt den Steuerpflichtigen das Zeitrisiko tragen – im Beispiel bleiben nach Eintragung im Februar 2026 nur vier Jahre bis zum 31.12.2029, und die Organschaft scheitert. Eine **relative** Formulierung (Beginn im Jahr der Eintragung, Kündigung erst nach fünf Jahren) verschiebt das Ende mit. Ein Billigkeitserlass nach § 163 AO kommt selbst ohne Verschulden nicht in Betracht. Die Mindestlaufzeit umfasst **60 Monate**, taggenau gerechnet – fällt das Ende in ein laufendes Wirtschaftsjahr, wird schlicht unterstellt, dieses werde umgestellt. In **Umwandlungsfällen** zählt die Rückwirkungszeit mit, und das zweite Beispiel zeigt, wie dieselbe Fiktion **verschieden** wirkt: Für die Laufzeit als **Rechengröße** trägt sie, für die finanzielle Eingliederung als **tatsächlichen Lebenssachverhalt** nicht. Ein neuer Vertrag rettet nur die Zukunft und lässt die fünf Jahre **neu** beginnen. Abzuführen ist der Betrag des **§ 301 AktG** – **betragsgenau** in beide Richtungen, denn auch ein Zuviel ist ein Durchführungsmangel. Die drei Abzüge schützen fremde Interessen (vororganschaftlicher Verlustvortrag, gesetzliche Rücklage, Gewinnrücklagen), die Hinzurechnung gibt zurück, was während der Organschaft zurückgelegt wurde. Beim **BilMoG** entsteht eine Asymmetrie: § 301 AktG verweist auf die Ausschüttungssperre des § 268 Abs. 8 HGB, § 302 AktG nicht – im Gewinnfall wirkt sie, im Verlustfall nach herrschender Meinung nicht. **Vorvertragliche** Gewinn- und Kapitalrücklagen unterliegen **nie** der Abführung, auch nicht bei späterer Auflösung: Sie schützen die **Minderheitsgesellschafter**, die vor der Organschaft an ihnen teilgehabt hätten – typisierend, auch wenn es keine gibt. Maßgeblich ist der Zeitpunkt der **Bildung**, weshalb die Rücklagen getrennt zu führen sind. Eine irrtümliche Abführung kostet die Organschaft, lässt sich aber heilen. Im ersten Beispiel zur Mindestlaufzeit liegen zwischen dem 01.07.2025 und dem 30.06.2029 allerdings nur **48 Monate**; fünf Zeitjahre endeten am 30.06.2030. Bei **Kapital**rücklagen kommt es – anders als bei Gewinnrücklagen – auf den Zeitpunkt der Bildung **nicht** an: § 301 AktG bezieht ihre Auflösung schlicht nicht ein, weil sie aus **Einlagen** stammt. Die **tatsächliche Durchführung** verlangt drei Schritte, die je für sich einen Mangel begründen: **richtige Ermittlung**, **Buchung** von Forderung und Verbindlichkeit zum Bilanzstichtag und **zeitnahe Erfüllung** mit echtem Mittelfluss. Stundung als **Darlehen** und Verrechnung mit werthaltigen Gegenansprüchen sind zulässig, bloßes **Stehenlassen** nicht – die Fußnote nennt 3 bis 12 Monate als angemessen. Schädlich ist, was den Betrag des § 301 AktG **verfälscht**, unschädlich, was er **selbst vorsieht**. Bei der **Verzinsung** trennt die Quelle fein: Die Verlustübernahme wird sofort fällig, die Gewinnabführung erst mit der Bilanzerstellung – ein Verstoß bleibt aber folgenlos, weil die Verzinsung nur **Nebenpflicht** ist und eine etwaige vGA im Organkreis als vorweggenommene Gewinnabführung unschädlich wäre. Die **Heilungsvorschrift** des § 14 Abs. 1 Nr. 3 Sätze 4 ff. KStG entschärft eine früher kaum tragbare Lage, denn maßgeblich ist der bei **objektiv ordnungsgemäßer** Bilanzierung richtige Betrag. Nicht die Art des Fehlers entscheidet, sondern seine Wirkung auf den Betrag – mit zwei Ausnahmen, denen ein gemeinsamer Grund zugrunde liegt: Bei der unzulässigen Gewinnrücklage und der unterlassenen Buchung fehlt es am **Willen zur Durchführung**, nicht an der Richtigkeit. Ein **nichtiger** Abschluss ist ausgeschlossen – es sei denn, die Nichtigkeit ist nach **drei Jahren** durch Zeitablauf geheilt. Die Heilung verbindet zwei Maßstäbe, die sonst Gegensätze sind: Für die **Höhe** gilt der **objektive** Fehlerbegriff, für die Heilung ein **subjektives** Element – sie schützt den sorgfältigen, nicht den nachlässigen Steuerpflichtigen. Ein **uneingeschränktes Testat** fingiert die Sorgfalt **unwiderleglich**, ein **eingeschränktes** ist immer schädlich, auch bei Einschränkung zu anderen Fragen; die Aufzählung ist **abschließend**. Wer § 264 Abs. 3 HGB nutzt, verliert die Fiktion – in Organschaftsfällen ist der HGB-Abschluss **immer** zu erstellen. Die **Korrekturfrist** bürdet ein erhebliches Risiko auf: Die Beanstandung ist **kein Verwaltungsakt** und der Rechtsbehelf **unterbricht sie nicht** – wer streiten will, muss vorsorglich korrigieren. Entlastend wirkt die **Wesentlichkeitsschwelle**: Was handelsrechtlich nicht korrigiert werden muss, verlangt auch das Steuerrecht nicht. **Verstoß** und **Beendigung** sind zu trennen: Jener betrifft die **Durchführung** und ist heilbar, diese den **Vertrag** und verlangt einen **wichtigen Grund**. Entscheidend ist die Zäsur nach fünf Jahren – **innerhalb** vernichtet ein Verstoß **alles**, **danach** nur das laufende Jahr; ob die Organschaft dann weiterläuft, hängt an der **Restlaufzeit** von fünf Jahren. Der **wichtige Grund** ist ein rein **steuerlicher** Begriff, weil das Zivilrecht keine Mindestlaufzeit kennt: Eine nur steuerlich motivierte Beendigung genügt nie, eine von vornherein feststehende versagt die Anerkennung sogar **von Anfang an**. Er rettet zudem nur die **Mindestlaufzeit**, nicht eine mangelhafte Durchführung der Vorjahre. Bei **Umwandlungen** gilt nur eine **Regelvermutung** für den wichtigen Grund – sie kippt bei rein steuerlichen Motiven, weshalb die betrieblichen Gründe zu dokumentieren sind. Eine **unterjährige Kündigung** wirkt auf den **Beginn des Wirtschaftsjahres** zurück, aber nur, wenn der Vertrag zivilrechtlich unterjährig beendet werden kann. Nach Ablauf der Mindestlaufzeit entfällt die Organschaft nur **ab dem Jahr der Beendigung** – auch ohne wichtigen Grund. **Liquidation und Insolvenz** beenden den Vertrag und sind wichtiger Grund; der **Abwicklungsgewinn** fällt dann bei der Organgesellschaft an, während bei einer **Aufspaltung** nach § 123 UmwG der Übertragungsgewinn noch abzuführen und beim Organträger zu versteuern ist. Haftet die Organgesellschaft nach **§ 73 AO**, ist die Zahlung eine **vGA** und nicht abziehbar. Damit ist Kapitel 2 vollständig. **§ 14 Abs. 5 KStG** stellt Organeinkommen und Nebengrößen gesondert und einheitlich fest und **dokumentiert zugleich die Organschaft**; bei einem Verstoß ergeht ein **negativer Feststellungsbescheid**. Weil er **Grundlagenbescheid** ist, wird der Streit dort geführt – ein Einspruch gegen den eigenen Steuerbescheid ist insoweit unbegründet. Zuständig ist das Finanzamt der **Organgesellschaft**, die allein erklärungspflichtig ist; die Befreiung des Organträgers gilt nur, solange sie ihre Pflicht **tatsächlich erfüllt**. Für die Gewerbesteuer gilt stattdessen § 35b GewStG. Ausgangsgröße ist der Jahresüberschuss **vor** Abführung: Weil die Abführung als **Aufwand** gebucht ist, beträgt der Bilanzgewinn regelmäßig **0 €** und muss zuerst **eliminiert** werden. Das Beispiel zeigt den Kern in einer Zahl – abgeführt werden 500.000 € (handelsrechtlich), zugerechnet 510.000 € (steuerlich). Beim **vororganschaftlichen Verlustvortrag** greifen drei Regeln ineinander: **Handelsrechtlich** zwingt § 301 AktG die Organgesellschaft, ihn **selbst** auszugleichen; **steuerlich** bleibt er ungenutzt, weil § 15 Satz 1 Nr. 1 KStG den Verlustabzug ausschließt; **bilanziell** entsteht aus der Differenz eine **Minderabführung**, die nach § 14 Abs. 3 KStG als **vororganschaftlich** gilt und zur **Einlage** wird – der Verlust wird also nicht vernichtet, sondern in Anschaffungskosten und Einlagekonto umgewandelt. Das **Schema** besteht aus drei Blöcken: Eliminierung der Abführung, gewöhnliche Einkommensermittlung, Abzug des Organeinkommens. Das eigene Einkommen beträgt **regelmäßig null** – Ausnahme sind **Ausgleichszahlungen** nach § 16 KStG. Eine echte **vGA** ist bei der Organgesellschaft kaum denkbar, weil der Gewinn ohnehin vollständig abgeführt wird; der Vorteil wird nur **vorweg** gewährt, weshalb die Durchführung **unberührt** bleibt und nur **analog** § 8 Abs. 3 Satz 2 KStG hinzugerechnet wird. **Verdeckte Einlagen** werden abgezogen und erhöhen das Einlagekonto; im Beispiel heben sich Ertrag und Abzug zu 500.000 € auf. Der **Spendenabzug** durchbricht den Grundgedanken der Organschaft: Er bleibt **getrennt**, der Höchstbetrag bemisst sich allein nach der Organgesellschaft, und ein **Spendenvortrag** bleibt ihr erhalten, weil § 15 Satz 1 Nr. 1 KStG nur § 10d EStG ausschließt. Die **Nichtgeltung von Vorschriften** hat zwei Gesichter. Der **Ausschluss des § 10d EStG** lässt den vororganschaftlichen Verlust zwar bestehen, aber **einfrieren**: Er ist während der Organschaft weder bei der Organgesellschaft abziehbar noch auf den Organträger übertragbar und lebt erst nach deren Ende wieder auf – die Kehrseite der handelsrechtlichen Kürzung nach § 301 AktG, die ihn bereits einmal aufgezehrt hat. Gefährlich ist die Wartezeit: Ein **§ 8c KStG**-Vorgang während des Einfrierens vernichtet ihn endgültig. Dieselbe Sperre trifft die Verluste nach **§ 15 Abs. 4 EStG** und **§ 15a EStG** sowie den fortführungsgebundenen Verlust nach **§ 8d KStG**, der doppelt gebunden ist: eingefroren **und** weiterhin an § 8d Abs. 2 KStG gefesselt. Spiegelbildlich bleibt ein **während** der Organschaft entstandener Verlust erst gar nicht bei der Organgesellschaft, weil der Organträger ihn nach § 302 AktG ausgleicht. Die **Bruttomethode** des § 15 Satz 1 Nr. 2 KStG löst dagegen ein Zurechnungsproblem: § 8b KStG ist bei der Organgesellschaft **nicht** anzuwenden, das Ergebnis geht **brutto** auf den Organträger über, und erst **dort** entscheidet sich nach dessen **Rechtsform**, ob Freistellung (§ 8b KStG) oder Teileinkünfteverfahren (§ 3 Nr. 40 EStG) greift. Die **Streubesitzgrenze** des § 8b Abs. 4 KStG wird nach Satz 4 **getrennt** geprüft – die Beteiligungen von Organträger und Organgesellschaft werden also nicht zusammengerechnet, was in beide Richtungen wirken kann. Die **Kapitalertragsteuer** rechnet § 19 Abs. 5 KStG beim Organträger an, obwohl die Organgesellschaft sie getragen hat. Im ersten Beispiel führt das zu einem **negativen** Ergebnis von ./. 45.000 €, weil die Betriebsausgaben in voller Höhe abziehbar bleiben, während die Ausschüttung zu 95 % freigestellt wird. Die **Zinsschranke** behandelt die Quelle ausdrücklich nur als Hinweis, folgt aber demselben Muster: § 15 Satz 1 Nr. 3 Satz 1 KStG **schließt sie bei der Organgesellschaft aus**, deren Zinsaufwendungen und EBITDA-Bestandteile unverändert im Organeinkommen bleiben und über den Feststellungsbescheid **mitgeteilt** werden; ein vororganschaftlicher **Zins- oder EBITDA-Vortrag** bleibt wie der Verlust **eingefroren**. Geprüft wird allein beim **Organträger**, weil der Organkreis nach Satz 2 als **ein Betrieb** gilt – eine Fiktion, die in **beide Richtungen** wirkt: Sie saldiert Zinsaufwand und Zinsertrag konzernweit und blendet die Beteiligung des Organträgers an seinen Organgesellschaften für die stand-alone-Prüfung aus, gewährt die **Freigrenze** aber nur **einmal** für den gesamten Kreis. Die drei Ausnahmen bauen **stufenweise** aufeinander auf: **Freigrenze** (§ 4h Abs. 2 Buchst. a EStG), dann **stand-alone-Betrachtung** (Buchst. b, die an jeder Beteiligung ab 25 % und an jeder ausländischen Betriebsstätte scheitert), dann die **Konzernklausel** (Buchst. c). Bei ihr kehrt sich die Anschauung um: Wer **keinem Konzern** angehört, kann den **Eigenkapitalvergleich** gar nicht führen, so dass die Zinsschranke gerade dann greift; bei einer Organträger-Kapitalgesellschaft tritt der **10%-Check** des § 8a Abs. 3 KStG hinzu. Im Beispiel treffen 3.000.000 € der Organgesellschaft und 1.000.000 € des Organträgers zu einem Nettozinsaufwand von **4.000.000 €** zusammen – allein durch die Zusammenfassung ist die Freigrenze überschritten. Die **Ausgleichszahlungen** sind die zivilrechtliche Kehrseite der vollständigen Abführung: Weil § 301 AktG den ganzen Jahresüberschuss dem Organträger zuweist, bleibt für eine Dividende der Minderheitsgesellschafter **nichts übrig**, weshalb § 304 AktG ihnen einen **Ausgleichsanspruch** gibt. Fehlt er im Vertrag, ist dieser bei AG und KGaA **nichtig**; tritt ein außenstehender Gesellschafter erst später hinzu, **endet** der Vertrag nach § 307 AktG von selbst – und der Neuabschluss lässt die Mindestlaufzeit **neu** beginnen. Bei der **GmbH** ist die Zahlung dagegen entbehrlich, weil der BFH eine im Zeitpunkt des Vertragsschlusses **unklare Zivilrechtslage** nicht zu Lasten des Steuerpflichtigen auslegt. Der Begriff des **außenstehenden Gesellschafters** entscheidet über zwei gegenläufige Risiken: Wird nicht gezahlt, obwohl er außensteht, droht die Nichtigkeit; wird gezahlt, obwohl er konzernverbunden ist, liegt ein **Durchführungsmangel** vor, weil dann nicht mehr der ganze Gewinn abgeführt wird – eine abschließende Definition gibt es dabei ausdrücklich **nicht**. Die Zahlung muss aus einem **festen Betrag** bestehen (**Garantiedividende**) und ist auch in **Verlustjahren** zu leisten; eine rein **variable** Bemessung am Gewinn der **Organgesellschaft** scheitert, eine am Gewinn des **Organträgers** nicht – entscheidend ist allein, **wessen** Gewinn gemindert wird. Die **gemischte** Zahlung rettet § 14 Abs. 2 KStG mit einer **Durchführungsfiktion**, mit der der Gesetzgeber die Verwaltungsauffassung gegen den BFH durchgesetzt hat: Sie prüft nicht mehr, ob der ganze Gewinn abgeführt wurde, sondern setzt eine **Obergrenze** – den Gewinnanteil nach **Nominalbeteiligung**, berechnet aus dem Gewinn **vor Abführung und ohne Organschaft**, jedes Jahr neu. Ihre Überschreitung ist ein Durchführungsmangel, der **innerhalb der Mindestlaufzeit** auf alle Vorjahre zurückwirkt. Bei den **Auswirkungen** greifen zwei Korrekturen ineinander, die sorgfältig zu trennen sind: **§ 4 Abs. 5 Nr. 9 EStG** trifft **denjenigen, der zahlt**, und macht den gebuchten Aufwand rückgängig; **§ 16 KStG** trifft **immer die Organgesellschaft** und weist ihr ein eigenes Einkommen von **20/17** der Ausgleichszahlungen zu. Der Bruch ist die **Umkehrung** der Körperschaftsteuer: Von 58.824 € bleiben nach 15 % genau die 50.000 € Zahlung übrig. Beide Korrekturen können in **verschiedenen Jahren** wirken – die Hinzurechnung schon mit der **Passivierung**, die Besteuerung erst mit dem **Abfluss**, weil § 16 KStG auf die „geleisteten“ Zahlungen abstellt. Dass das Einkommen **stets** bei der Organgesellschaft bleibt, hat einen klaren Grund: Die Belastung darf sich nicht nach der **Rechtsform des Organträgers** richten. Deshalb zahlt die Organgesellschaft auch dann Körperschaftsteuer, wenn sie selbst einen **Verlust** erwirtschaftet – und ein **vororganschaftlicher** Verlustvortrag hilft ihr nicht, weil § 15 Satz 1 Nr. 1 KStG den Abzug auch gegen dieses Einkommen sperrt. Als Ausgleichszahlung gilt auch eine **vGA** an den außenstehenden Gesellschafter. In der **Abwandlung** stellt die Quelle allerdings zwei Rechenwege nebeneinander, die zu **verschiedenen** Organeinkommen führen (1.050.485 € und 1.000.485 €) und sich erst beim Organträger wieder ausgleichen – konsequent ist nur der zweite, weil bei Zahlung durch den Organträger bei der Organgesellschaft gar kein Aufwand gebucht ist. Alles Weitere zur Ausgleichszahlung folgt aus **einem** Satz: Sie ist rechtlich **stets eine Leistung der Organgesellschaft**, gleichgültig aus wessen Kasse sie fließt. Deshalb schuldet und meldet **sie** die Kapitalertragsteuer, deshalb ist **ihr** Einlagekonto mit dem Bestand zum **Vorjahresende** maßgebend, und die Zahlung durch den Organträger ist nur ein **abgekürzter Zahlungsweg**, weil sie wirtschaftlich aus der Gewinnabführung stammt. Für denselben Vorgang nennt das Skript damit **vier** Zeitpunkte: Passivierung (§ 4 Abs. 5 Nr. 9 EStG), Abfluss (§ 16 KStG), Zufluss (Kapitalertragsteuer) und Vorjahresende (Einlagekonto). Beim **Minderheitsgesellschafter** ist die Zahlung eine Einnahme nach § 20 Abs. 1 Nr. 1 EStG, deren Behandlung sich nach **seiner** Rechtsform richtet – ein aufschlussreicher Gegensatz, denn auf der Ebene der Organgesellschaft sorgt § 16 KStG gerade für **Rechtsformneutralität**. Weil die Organgesellschaft regelmäßig keinen ausschüttbaren Gewinn hat, ist die **Einlagenrückgewähr** der Normalfall: Die Zahlung mindert zunächst die **Anschaffungskosten**, ein Überhang führt zum **Veräußerungstatbestand**. **Gewinnausschüttungen** sind trotz voller Abführung in **fünf** Fällen möglich, und sie haben einen gemeinsamen Nenner – erfasst ist genau das, was der **Abführungspflicht des § 301 AktG nicht unterliegt**: die beiden Fälle des § 16 KStG, die vororganschaftlichen Rücklagen, die Kapitalrücklagen auch aus organschaftlicher Zeit und die nur **fingierte** Ausschüttung der vororganschaftlichen Mehrabführung. Damit ist die Einkommensermittlung bei der Organgesellschaft abgeschlossen. **Beim Organträger** vollzieht sich **dieselbe Bewegung mit umgekehrtem Vorzeichen**: Zu eliminieren ist hier der **Ertrag** aus der Abführungsforderung, dort war es der Aufwand – sonst würde derselbe Betrag zweimal erfasst. Dass für die Verrechnung **§ 10d EStG nicht gilt**, ist der praktische Hauptvorteil der Organschaft: Ein negatives Organeinkommen wird **unmittelbar und unbeschränkt** mit dem eigenen Einkommen verrechnet, die **Mindestbesteuerung** greift nicht. **Zeitlich** entscheidet allein das Wirtschaftsjahresende der **Organgesellschaft**, denn die Organschaft ändert, **wer** versteuert, nicht **wann**. Bei abweichenden Wirtschaftsjahren fallen deshalb Zurechnung und Eliminierung **auseinander** – zugerechnet wird das Organeinkommen des laufenden Jahres, eliminiert der Abführungsanspruch des Vorjahres. Bei einer **Personengesellschaft** als Organträger erhält der unterjährig ausgeschiedene Mitunternehmer **nichts**, auch nicht zeitanteilig, weil die Abführung ein **zeitpunktbezogener** Vorgang ist. Bei **Beteiligungserträgen** und beim Wahlrecht zum **Abzug ausländischer Steuer** entscheidet wieder der Organträger – der Feststellungsbescheid ist dafür die **Datenbrücke**. Seine **laufenden** Beteiligungsaufwendungen sind **voll** abziehbar, weil er aus der Organbeteiligung gar keine steuerfreien Einnahmen bezieht; **substanzbezogene** Gewinnminderungen bleiben dagegen nach § 8b Abs. 3 Satz 3 KStG außer Ansatz, weil diese Vorschrift an die Beteiligung **als solche** anknüpft. Die **weiteren Einzelfragen** kreisen um denselben Gedanken – **keine doppelte Erfassung**. Die handelsrechtlich gebotene **Drohverlustrückstellung** des Organträgers scheitert an § 5 Abs. 4a EStG und wäre auch sachlich verfehlt, weil ihn der Verlust ohnehin als negatives Organeinkommen erreicht. Die **Teilwertabschreibung** auf die Organbeteiligung scheitert gleich **zweifach**: Eine erwartete Verlustübernahme taugt nicht als Begründung, weil § 302 AktG den Verlust ausgleicht und die Beteiligung dadurch gerade **nicht** an Wert verliert; und selbst eine berechtigte Abschreibung bliebe nach § 8b Abs. 3 Satz 3 KStG außer Ansatz. Der **Spendenabzug** bleibt – spiegelbildlich zur Organgesellschaft – **getrennt**: Das zugerechnete Organeinkommen hebt den Höchstbetrag des Organträgers **nicht** an. Bei der **vorweggenommenen Gewinnabführung** korrigiert R 14.7 Abs. 2 KStR **nur beim Organträger**, nie das Organeinkommen – und die beiden Beispiele zeigen, warum das Ergebnis verschieden ausfällt: Im **Zinsfall** hebt die Korrektur genau das auf, was die Zurechnung bringt (zvE bleibt 2.000.000 €); im **Grundstücksfall** hat der Organträger dagegen einen **Vermögensvorteil** erhalten, den er noch nicht versteuert hatte, so dass 2.490.000 € verbleiben – wirtschaftlich richtig, denn er hält ein Grundstück im Wert von 500.000 € für 10.000 €. Die **verdeckte Einlage** ist der **spiegelbildliche** Fall: Hier bleibt das Organeinkommen unberührt (§ 8 Abs. 3 Satz 3 KStG), während beim Organträger eine einzige Buchung **zweierlei** leistet – Erhöhung der Anschaffungskosten um den Teilwert und Aufdeckung der stillen Reserven von 400.000 €. Bei **§ 8c KStG** entscheidet allein der **Zeitpunkt** des Erwerbs, und der Unterschied ist erheblich. **Unterjährig** unterbleibt jede **Ergebniskonsolidierung** – die Gewinnabführung ist in diesem Augenblick **noch nicht entstanden**, Organgesellschaft und Organträger stehen sich wie zwei selbstständige Gesellschaften gegenüber; nötig sind **Zwischenabschlüsse**, gekürzt wird auf **beiden Ebenen getrennt**. Beim Erwerb **mit Ablauf des Wirtschaftsjahres** wird dagegen zuerst **konsolidiert**, so dass das negative Organeinkommen Teil des Verlustes des Organträgers wird und mit untergeht. Im selben Zahlenbeispiel verbleiben dem Organträger deshalb unterjährig noch **1.000.000 €** Verlustvortrag, beim Erwerb zum Stichtag dagegen **nichts** – ein Erwerb einen Tag vor dem Bilanzstichtag ist also **günstiger** als einer mit dessen Ablauf. Für die Organgesellschaft kehrt sich das Bild um: unterjährig trifft § 8c KStG ihren **eigenen** laufenden Verlust, beim Stichtagserwerb nur noch den **vororganschaftlichen** – der allerdings in **beiden** Fällen untergeht und damit die Warnung bestätigt, dass der eingefrorene Verlust jahrelang unnutzbar, aber die ganze Zeit gefährdet ist. Die **Stille-Reserven-Klausel** wirkt im Organkreis **ungünstiger** als sonst: Beim Organträger bleiben die stillen Reserven der **Organbeteiligung** außer Betracht, weil ihre Realisierung nach § 8b KStG steuerfrei wäre – gerade der Posten also, in dem sich die Werthaltigkeit des Organkreises sammelt. Die Mehr- und Minderabführungen und die gewerbesteuerliche Organschaft folgen nach demselben Verfahren."
