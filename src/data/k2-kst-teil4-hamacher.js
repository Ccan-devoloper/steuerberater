...
export const kstTeil4 = [
  ...
  },
  {
    id: "kst-t4-52",
    kapitel: "52",
    abschnittNr: "5.6 (§ 1 AStG)",
    title: "5.6 Anwendung des § 1 AStG in Dreiecksfällen – wenn sich die vGA im Inland verbraucht",
    thema: "Verbraucht sich die vGA beim inländischen Anteilseigner gegenläufig als Aufwand, führen die vGA-Grundsätze zu einem unzutreffenden Inlandseinkommen. Dann verdrängt § 1 AStG den § 8 Abs. 3 Satz 2 KStG vollständig",
    rechtsstand: RECHTSSTAND,
    quelle: "KSt Teil IV (Hamacher), Abschnitt 5.6 (Anwendung des § 1 AStG) · Stand 07/2025",
    verfasser: VERFASSER,
    normen: [
      "§ 8 Abs. 3 Satz 2 KStG",
      "§ 8 Abs. 1 Satz 1 KStG",
    ...
    themen: ["§ 1 AStG im Dreiecksfall", "Nutzungsvorteil", "gegenläufiger Verbrauch", "Inlandseinkommen", "nahe stehende Person nach § 1 Abs. 2 AStG", "Verrechnungspreis"],
    bloecke: [
      { text: "Ist die bevorteilte Gesellschaft im Ausland ansässig, ist auch in diesen Fällen die Anwendung des § 1 AStG zu prüfen. Nach Tz. 1.3 des BMF-Schreibens vom 06.06.2023 hängt dies davon ab, ob sich der durch die vGA ausgelöste Tatbestand im Inland gegenläufig wieder verbraucht, wie eben in den Fällen eines Nutzungsvorteils (siehe unter 5.5.2). Dadurch würde sich bei Anwendung der vGA-Grundsätze ein unzutreffendes Inlandseinkommen ergeben, weil sich der Tatbestand der Einkünftekorrektur eigentlich nur bei der ausländischen Schwestergesellschaft (z.B. als zusätzlicher Zinsaufwand) auswirken dürfte, nicht aber auf der Ebene des gemeinsamen Anteilseigners als weiterer beteiligungsbezogener Aufwand. Die Besteuerung der verdeckten Gewinnausschüttung i.S. des § 20 Abs. 1 Nr. 1 Satz 2 EStG beim Anteilseigner ist hierfür unmaßgeblich. Daher wird in dieser Fallgruppe die Anwendung des § 8 Abs. 3 Satz 2 KStG insgesamt durch die Einkünftekorrektur des § 1 AStG verdrängt, was dann auch beim gemeinsamen Anteilseigner zu keinen weiteren vGA-Auswirkungen führt." },
      { text: "In den anderen Dreiecksfällen, bei denen es dann auf der Anteilseignerebene zu einer verdeckten Einlage in die bevorteilte Gesellschaft kommt, scheidet daher die Anwendung des § 1 AStG wiederum aus, weil alleine durch Erfassung der vGA nach der Einkünftekorrektur i.S. des § 8 Abs. 3 Satz 2 KStG das zutreffende Inlandseinkommen abgebildet wird. Es sei denn, nach § 1 Abs. 1 Satz 4 AStG ist aufgrund abweichender Bewertung der Verrechnungspreise eine weitere Einkommenskorrektur notwendig." },
      { text: "Beispiel: Die C-GmbH ist Alleingesellschafter der A-GmbH als auch der in den Niederlanden ansässigen B-BV. Am 01.01.2024 gewährt die A-GmbH der B-BV ein Darlehen über 1.000.000 € für 2 % Zinsen, obwohl der angemessene Zinssatz bei 10 % (auch Verrechnungspreis) liegt." },
      { text: "Lösung: Eigentlich würde die verbilligte Überlassung des Darlehens aus Sicht der A-GmbH zu einer verdeckten Gewinnausschüttung führen, weil diese aufgrund die Leistungsbeziehung eine verhinderte Vermögensmehrung erleidet, die zudem auf dem Gesellschaftsverhältnis beruht. Denn die bevorteilte B-BV ist eine nahe stehende Person des gemeinsamen Anteilseigners C-GmbH. Danach müsste nach § 8 Abs. 3 Satz 2 KStG eine Einkommenskorrektur um 80.000 € erfolgen. (Die Form „aufgrund die Leistungsbeziehung“ steht so in der Quelle.)" },
      { text: "Vorliegend ist aber zu beachten, dass die Anwendung der vGA-Grundsätze unter Berücksichtigung der Auswirkungen beim gemeinsamen Anteilseigner C-GmbH zu einem unzutreffenden Inlandseinkommen führen würde. Denn unbeachtlich der Besteuerung der vGA als Bezug i.S. des § 20 Abs. 1 Nr. 1 Satz 2 EStG verbraucht sich der Tatbestand beim Anteilseigner vollumfänglich als beteiligungsbezogener Aufwand, weil keine verdeckte Einlage in die B-BV vorliegt. Denn im Bezug zur B-BV handelt es sich um einen Nutzungsvorteil, weil kein einlagefähiges Wirtschaftsgut vorliegt. Damit würde das Inlandseinkommen in dieser Situation letztlich 0 € betragen. Dies ist aber unzutreffend, weil die Einkommenskorrektur eigentlich die Zinsen abbilden sollte, die unter angemessenen Tatbeständen bei der B-BV zu einem Aufwand geführt hätten. Damit wäre der eigentliche Verbrauch der Einkommenskorrektur nur im Ausland eingetreten und nicht auf Ebene des inländischen Anteilseigners." },
      { text: "Daher kommt es vorrangig zur Anwendung des § 1 AStG, wodurch das Einkommen der A-GmbH außerbilanziell um 80.000 € zu erhöhen ist. Denn die Voraussetzungen des § 1 Abs. 1 und Abs. 2 AStG sind erfüllt, weil die B-BV (= Person) nach § 1 Abs. 2 Nr. 3a) AStG als nahe stehende Person der A-GmbH (= Steuerpflichtiger) gilt. Denn die C-GmbH ist in diesem Fall die dritte Person, die sowohl an der B-BV als auch der A-GmbH mit mindestens 25 % wesentlich beteiligt ist. Durch Hinzurechnung der 80.000 € wird damit das zutreffende Inlandseinkommen besteuert. Gleichzeitig sind aber auch auf Ebene der C-GmbH keine vGA-Grundsätze zu beachten, d.h. es entstehen keine Beteiligungserträge und es kommt zu keinem Aufwandsverbrauch." },
      { text: "Beispiel: Die inländische C-GmbH ist Alleingesellschafter der niederländischen B-BV als auch der inländischen B-GmbH. Am 01.01.2025 gewährt die B-BV der B-GmbH ein Darlehen über 1.000.000 € für 20 % Zinsen, obwohl der angemessene Zinssatz bei 10 % (= Verrechnungspreis) liegt." },
      { text: "Lösung: Aus Sicht der B-GmbH handelt es sich um eine Vermögensminderung, da sie unter ordentlichen Umständen nur Zinsen i.H. von 100.000 € gezahlt hätte. Da dieser Vorgang gegenüber einer dem Anteilseigner nahe stehenden Person erfolgt ist, liegt eine verdeckte Gewinnausschüttung vor. Diese beträgt 100.000 € und ist dem Einkommen außerbilanziell nach § 8 Abs. 3 Satz 2 KStG wieder hinzuzurechnen. § 8 Abs. 3 Satz 2 KStG: 100.000 €." },
      { text: "Weil es auf Ebene des gemeinsamen Anteilseigners gleichzeitig zu einer verdeckten Einlage in die B-BV kommt und sich die Anschaffungskosten dieser Beteiligung nach § 8 Abs. 1 Satz 1 KStG i.V. mit § 6 Abs. 6 Satz 2 EStG entsprechend erhöhen, ist ein aufwandswirksamer Verbrauch der vGA bei diesem ausgeschlossen. Damit wird alleine durch Anwendung der Einkommenskorrektur nach § 8 Abs. 3 Satz 2 KStG das zutreffende Inlandseinkommen hergestellt, weil sich bei der B-GmbH nur ein Zinsaufwand von 100.000 € auswirkt. Dadurch kommt es auch nicht mehr zur Anwendung der Korrektur nach § 1 AStG." },
      { text: "Daneben erzielt die C-GmbH erzielt aus der vGA Einnahmen i.S. des § 20 Abs. 1 Nr. 1 Satz 2 EStG von 100.000 €, die nach § 8b Abs. 1 Satz 1 KStG steuerfrei sind, weil auch § 8b Abs. 4 Satz 1 KStG und § 8b Abs. 1 Satz 2 KStG steuerfrei sind. Gleichzeitig kommt es zur Anwendung der Betriebsausgabenpauschalierung nach § 8b Abs. 5 Satz 1 KStG, so dass das steuerpflichtige Einkommen daraus 5.000 € beträgt. Die Auswirkung aus der Besteuerung der Beteiligungserträge ist bei der Prüfung des zutreffenden Inlandseinkommens aber auszublenden. (Das doppelte „erzielt“ und die Formulierung „weil auch § 8b Abs. 4 Satz 1 KStG und § 8b Abs. 1 Satz 2 KStG steuerfrei sind“ stehen so in der Quelle; gemeint ist, dass beide Vorschriften der Steuerfreiheit nicht entgegenstehen.)" },
      { text: "Buchhalterische Auswirkung bei der C-GmbH: Stufe 1: Beteiligung B-BV an Ertrag 100.000 €. Einkommensermittlung C-GmbH: ./. § 8b Abs. 1 Satz 1 KStG 100.000 €; + § 8b Abs. 5 Satz 1 KStG 5.000 €; = zu versteuerndes Einkommen: 5.000 €." },
      { typ: "tabelle", spalten: ["Konstellation", "verbraucht sich die vGA beim inländischen Anteilseigner?", "Folge"], zeilen: [
        ["Nutzungsvorteil an die ausländische Schwestergesellschaft", "ja – vollständig als beteiligungsbezogener Aufwand, weil keine Einlage möglich ist", "§ 1 AStG verdrängt § 8 Abs. 3 Satz 2 KStG insgesamt; beim Anteilseigner keine vGA-Folgen"],
        ["Wirtschaftsgut oder Geld an die ausländische Schwestergesellschaft", "nein – die vGA verbraucht sich in einer verdeckten Einlage, die die Anschaffungskosten erhöht", "§ 8 Abs. 3 Satz 2 KStG stellt das zutreffende Inlandseinkommen bereits her; § 1 AStG scheidet aus"],
        ["Verrechnungspreis weicht vom gemeinen Wert ab", "unerheblich", "ergänzende Korrektur nach § 1 Abs. 1 Satz 4 AStG"],
      ] },
      { typ: "tabelle", spalten: ["Beispiel", "Korrekturnorm", "Betrag", "Ergebnis beim gemeinsamen Anteilseigner"], zeilen: [
        ["zinsverbilligtes Darlehen an die niederländische B-BV", "§ 1 AStG bei der A-GmbH", "+ 80.000 €", "keine Beteiligungserträge, kein Aufwandsverbrauch"],
        ["überteuertes Darlehen der B-BV an die inländische B-GmbH", "§ 8 Abs. 3 Satz 2 KStG bei der B-GmbH", "+ 100.000 €", "Beteiligungsertrag 100.000 €, steuerfrei; zvE 5.000 € aus der Pauschale"],
      ] },
      { text: "Rechenproben (eigene Ergänzung): Erstes Beispiel: 10 % ./. 2 % = 8 % von 1.000.000 € = 80.000 €. Zweites Beispiel: 20 % ./. 10 % = 10 % von 1.000.000 € = 100.000 €; 5 % davon = 5.000 €. Bemerkenswert ist die **Probe über beide Ebenen** im ersten Beispiel: Ohne § 1 AStG stünden bei der A-GmbH + 80.000 € und beim Anteilseigner ./. 80.000 € Aufwand, die sich zu 0 € aufheben – genau das Ergebnis, das die Quelle als unzutreffend verwirft." },
      { text: "Anmerkung zum Entscheidungskriterium (eigene Ergänzung): Der ganze Abschnitt hängt an einer einzigen Frage, die die Quelle mit „gegenläufig wieder verbraucht“ umschreibt: **Bleibt die Einkünftekorrektur im Inland stehen oder nicht?** Wandert ein Wirtschaftsgut oder Geld, verbraucht sich die vGA beim Gesellschafter in einer **verdeckten Einlage**, die nur die Anschaffungskosten erhöht und das Einkommen nicht mindert – die Korrektur bleibt also wirksam, und § 1 AStG wird nicht gebraucht. Wandert dagegen ein **Nutzungsvorteil**, verbraucht sie sich in **abziehbarem Aufwand**, und die Hinzurechnung wird auf Ebene des Gesellschafters wieder aufgehoben. Genau dieser Effekt macht die vGA-Lösung untauglich, und § 1 AStG tritt an ihre Stelle." },
      { text: "Anmerkung zur Reichweite der Verdrängung (eigene Ergänzung): Die Quelle sagt etwas Ungewöhnliches, das leicht überlesen wird: § 1 AStG verdrängt die vGA hier **insgesamt**, so dass beim gemeinsamen Anteilseigner **überhaupt keine** vGA-Folgen mehr eintreten – weder Beteiligungserträge noch Aufwandsverbrauch. Das unterscheidet diese Konstellation deutlich von Abschnitt 4.4, wo beide Normen **nebeneinander** standen und § 1 AStG nur ergänzend hinzurechnete. Der Grund ist die Zielrichtung: In Abschnitt 4.4 ging es um eine Wertdifferenz, hier um die Frage, **auf welcher Ebene** die Korrektur überhaupt stehen bleibt. Die Quelle stützt sich dafür ausdrücklich auf Tz. 1.3 des BMF-Schreibens vom 06.06.2023." },
      { text: "Anmerkung zum Nahestehen nach § 1 Abs. 2 AStG (eigene Ergänzung): Die Quelle prüft das Nahestehen sorgfältig und über eine andere Vorschrift, als man aus dem Körperschaftsteuerrecht gewohnt ist. Nicht die nahe stehende Person i.S. des § 8 Abs. 3 Satz 2 KStG ist maßgebend, sondern § 1 Abs. 2 Nr. 3 Buchstabe a AStG mit seiner **Mindestbeteiligung von 25 %** an beiden Gesellschaften. Steuerpflichtiger ist dabei die inländische A-GmbH, nahe stehende Person die ausländische B-BV, und die gemeinsame Mutter ist die „dritte Person“, die das Nahestehen vermittelt. Die Schwestergesellschaften stehen einander also nicht unmittelbar nahe, sondern **über** die Mutter – dieselbe Dreieckskonstruktion wie im Körperschaftsteuerrecht, nur mit eigener Vorschrift und eigener Beteiligungsschwelle." },
      { text: "Anmerkung zur Ausblendung der Beteiligungserträge (eigene Ergänzung): Der Schlusssatz des zweiten Beispiels wiederholt, was schon Abschnitt 4.4 festgehalten hat: Bei der Prüfung des zutreffenden Inlandseinkommens sind die Beteiligungserträge des Anteilseigners **auszublenden**. Das ist wichtig, weil sonst das Ergebnis verfälscht würde – die 5.000 € aus der Fünf-Prozent-Pauschale sind eine Folge der Ausschüttungsbesteuerung und haben mit der Frage, ob die Einkünftekorrektur bei der leistenden Gesellschaft ausreicht, nichts zu tun. Geprüft wird allein, ob der **Zinsaufwand** der inländischen Gesellschaft auf das angemessene Maß zurückgeführt worden ist." },
    ],
  },
  {
    id: "kst-t4-53",
    kapitel: "53",
    abschnittNr: "5.7",
    title: "5.7 Besonderheit bei der Schenkungsteuer – § 7 Abs. 8 Satz 2 ErbStG im Konzern",
    thema: "§ 7 Abs. 8 Satz 2 ErbStG definiert die freigebigen Zuwendungen im Konzern abschließend und setzt anders als Satz 1 einen Bereicherungswillen voraus. Bei beteiligungsidentischen Gesellschaften scheidet eine Zuwendung aus",
    rechtsstand: RECHTSSTAND,
    quelle: "KSt Teil IV (Hamacher), Abschnitt 5.7 · Stand 07/2025",
    verfasser: VERFASSER,
    normen: [
      ...
      "§ 15 Abs. 4 ErbStG",
      "§ 15 AO",
      "R E 7.5 Abs. 14 ErbStR",
      "§ 8 Abs. 3 Satz 2 KStG",
      "§ 8 Abs. 3 Satz 3 KStG",
      "BFH vom 30.01.2013, BStBl. II 2013, 930",
    ],
    themen: ["Schenkungsteuer im Dreiecksfall", "§ 7 Abs. 8 ErbStG", "Bereicherungswille", "Wertsteigerung der Anteile", "§ 15 Abs. 4 ErbStG", "Beteiligungsidentität"],
    bloecke: [
      { text: "Bei den Dreiecksfällen muss im Zusammenhang mit den schenkungsteuerlichen Auswirkungen die Sonderregelung des § 7 Abs. 8 Satz 2 ErbStG beachtet werden. Die Vorschrift ist die Reaktion des Gesetzgebers auf abweichende BFH-Rechtsprechung, wonach im Verhältnis zwischen der Gesellschaft und dem Anteilseigner freigebige Zuwendungen ausgeschlossen sein sollen. § 7 Abs. 8 Satz 2 ErbStG muss aber im Kontext zu § 7 Abs. 8 Satz 1 ErbStG verstanden werden, weil Satz 2 abschließend die Fälle der freigebigen Zuwendungen im Konzern definiert, d.h. darin ist kein weiterer gesetzlicher Tatbestand zu sehen." },
      { text: "Gegenstand der Regelung ist die schenkungsteuerliche Erfassung einer Zuwendung zwischen Kapitalgesellschaften, wenn dadurch auf Ebene des Gesellschafters der bevorteilten Gesellschaft eine Bereicherung eintritt. Diese Bereicherung ergibt sich nach der Grundaussage des § 7 Abs. 8 Satz 1 ErbStG wiederum in Höhe der Wertsteigerung der Anteile. Dafür ist aber unabdingbare Voraussetzung, dass mit dieser Gestaltung auch tatsächlich die Absicht zur Bereicherung zusammenhängt. Denn im Gegensatz zur Fiktion des § 7 Abs. 8 Satz 1 ErbStG setzt § 7 Abs. 8 Satz 2 ErbStG den Bereicherungswillen geradezu voraus, d.h. die Gesellschaft muss auch fremdnützig gehandelt und damit auch den Zuwendungswillen an den anderen Gesellschafter gehabt haben." },
      { text: "Das Handeln der Kapitalgesellschaft ist dann dem (Mit-)Gesellschafter zuzurechnen, von dem der Wille zur Unentgeltlichkeit ausgegangen ist. Sind an den beiden Kapitalgesellschaften nahe Angehörige i.S. des § 15 AO beteiligt, kann der Bereicherungswille daher regelmäßig unterstellt werden. Eine Ausnahme gilt wiederum, wenn die Gesellschaft nachweisbar eigennützig (und damit ausschließlich im eigenbetrieblichen Interesse) gehandelt hat und daher eine Zuwendung an den anderen Gesellschafter gerade nicht beabsichtigt gewesen ist." },
      { text: "Als Zuwendender gilt in diesen Fällen die Kapitalgesellschaft, bei der die verdeckte Gewinnausschüttung ausgelöst wurde, welche dadurch dieses Potential (in Höhe der Wertsteigerung der Anteile) dem Gesellschafter der anderen Kapitalgesellschaft zuwendet (Grundaussage des § 7 Abs. 8 Satz 1 ErbStG). Für Zwecke der Steuerberechnung gilt aber § 15 Abs. 4 ErbStG, d.h. hierfür ist abweichend von der Zuwendungsrichtung das persönliche Verhältnis zwischen den Anteilseignern maßgebend. Dies kann Auswirkungen auf den Steuersatz und den anzuwendenden Freibetrag haben." },
      { text: "Im Umkehrschluss bedeutet dies, dass kein schenkungsteuerpflichtiger Tatbestand vorliegt, wenn an beiden Kapitalgesellschaften dieselben natürlichen Personen unmittelbar oder mittelbar im gleichen Beteiligungsverhältnis beteiligt sind und daher eine Verschiebung der Beteiligungswerte bzw. eine Bereicherung eines Mitgesellschafters ausgeschlossen ist." },
      { text: "Beispiel: Die A-GmbH liefert der B-GmbH ein Grundstück und verlangt einen um 500.000 € zu niedrigen Kaufpreis. An der A-GmbH ist ausschließlich A beteiligt, an der B-GmbH sind hingegen A und B zu jeweils 50 % beteiligt. A und B sind nahe Angehörige." },
      { text: "Lösung: Körperschaftsteuerlich führt die vergünstigte Übertragung des Grundstücks zu einer verdeckten Gewinnausschüttung der A-GmbH an A. A wiederum legt anschließend den Vermögensvorteil von 500.000 € in die B-GmbH im Wege einer verdeckten Einlage ein, wodurch sich seine Anschaffungskosten der Beteiligung an der B-GmbH erhöhen." },
      { text: "Für Zwecke der Schenkungsteuer ist in diesem Zusammenhang § 7 Abs. 8 Satz 2 ErbStG zu beachten. Nach dieser Definition kann im Konzern ein schenkungsteuerpflichtiger Tatbestand angenommen werden, wenn es absichtlich zu einer Bereicherung eines anderen Gesellschafters gekommen ist. Dies ist in Höhe von 50 % und hinsichtlich des Gesellschafters B zu bejahen, weil in diesem Verhältnis eine Wertsteigerung der Anteile eingetreten ist. Als Zuwendender gilt in dieser Situation die A-GmbH, wobei hinsichtlich der Steuerberechnung aufgrund § 15 Abs. 4 ErbStG das persönliche Verhältnis zwischen den beiden Anteilseignern maßgeblich ist. Bemessungsgrundlage der Schenkungsteuer wäre der gemeine Wert, der sich nach der Vorteilszuwendung ergibt (hier: 250.000 €). Weil A und B nahe stehende Personen sind, kann ein Zuwendungswille des A, welcher durch die verbilligte Übertragung durch seine A-GmbH vollzogen worden ist, widerlegbar unterstellt werden." },
      { text: "Abwandlung: Sowohl an der A-GmbH als auch an der B-GmbH sind A und B zu jeweils 50 % beteiligt." },
      { text: "Lösung: In diesem Fall ist kein schenkungsteuerpflichtiger Tatbestand gegeben. Denn nach der abschließenden Definition des § 7 Abs. 8 Satz 2 ErbStG ist eine Zuwendung ausgeschlossen, weil die beiden Gesellschaften beteiligungsidentisch sind. Ertragsteuerlich wäre die verdeckte Gewinnausschüttung der A-GmbH und die anschließende verdeckte Einlage in die B-GmbH beiden Gesellschaftern zuzurechnen." },
      { typ: "tabelle", spalten: ["Frage zu § 7 Abs. 8 Satz 2 ErbStG", "Antwort der Quelle"], zeilen: [
        ["Anlass der Vorschrift", "Reaktion des Gesetzgebers auf die BFH-Rechtsprechung, wonach zwischen Gesellschaft und Anteilseigner keine freigebige Zuwendung möglich ist"],
        ["Verhältnis zu Satz 1", "Satz 2 definiert die Fälle im Konzern abschließend und ist kein weiterer eigener Tatbestand"],
        ["Gegenstand", "Zuwendung zwischen Kapitalgesellschaften, wenn beim Gesellschafter der bevorteilten Gesellschaft eine Bereicherung eintritt"],
        ["Höhe der Bereicherung", "Wertsteigerung der Anteile"],
        ["Bereicherungswille", "anders als bei der Fiktion des Satzes 1 zwingend erforderlich – die Gesellschaft muss fremdnützig gehandelt haben"],
        ["Zurechnung", "das Handeln der Gesellschaft wird dem Mitgesellschafter zugerechnet, von dem der Wille zur Unentgeltlichkeit ausging"],
        ["nahe Angehörige i. S. des § 15 AO", "der Bereicherungswille kann regelmäßig unterstellt werden – widerlegbar"],
        ["Gegenbeweis", "die Gesellschaft hat nachweisbar eigennützig, also ausschließlich im eigenbetrieblichen Interesse gehandelt"],
        ["Zuwendender", "die Kapitalgesellschaft, bei der die vGA ausgelöst wurde"],
        ["Steuerberechnung", "§ 15 Abs. 4 ErbStG – maßgebend ist abweichend von der Zuwendungsrichtung das persönliche Verhältnis der Anteilseigner"],
        ["beteiligungsidentische Gesellschaften", "kein schenkungsteuerpflichtiger Tatbestand, weil keine Wertverschiebung eintreten kann"],
      ] },
      { typ: "tabelle", spalten: ["Beteiligungsverhältnisse", "schenkungsteuerliche Folge", "Betrag"], zeilen: [
        ["A-GmbH: A zu 100 %; B-GmbH: A und B zu je 50 %", "Zuwendung an B, Zuwendender ist die A-GmbH", "250.000 € (50 % von 500.000 €)"],
        ["A-GmbH und B-GmbH: A und B zu je 50 %", "kein schenkungsteuerpflichtiger Tatbestand – Beteiligungsidentität", "kein Betrag"],
      ] },
      { text: "Rechenprobe (eigene Ergänzung): Die Zuwendung von 500.000 € erhöht den Wert der B-GmbH um denselben Betrag; B ist daran zu 50 % beteiligt, so dass seine Anteile um 250.000 € an Wert gewinnen – genau der von der Quelle genannte Betrag. Die anderen 250.000 € entfallen auf A selbst, und insoweit kann er sich nichts schenken. In der Abwandlung wird der Zuwachs bei der B-GmbH von A und B je zur Hälfte getragen, aber der Verlust bei der A-GmbH ebenso – **jeder erhält genau so viel, wie er verliert**, und deshalb kann niemand bereichert sein." },
      { text: "Anmerkung zum Unterschied zwischen Satz 1 und Satz 2 (eigene Ergänzung): Der wichtigste Satz des Abschnitts ist der, dass § 7 Abs. 8 Satz 1 ErbStG eine **Fiktion** enthält, Satz 2 dagegen den **Bereicherungswillen voraussetzt**. Das kehrt die Prüfung um: Bei der Einlage in die eigene Gesellschaft (Satz 1) kommt es auf die Absicht nicht an, im Konzernfall (Satz 2) dagegen entscheidet sie. Praktisch wird der Wille bei nahen Angehörigen **widerlegbar unterstellt** – ein Beweisanzeichen, kein Automatismus. Wer nachweist, dass die Gesellschaft ausschließlich im eigenbetrieblichen Interesse gehandelt hat, entgeht der Schenkungsteuer trotz eingetretener Wertverschiebung." },
