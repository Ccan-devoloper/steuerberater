      ...
      <main className="page">
        ...
        {ansicht === "skript-melzer" && (
          <KurzskriptBloecke
            ...
            lead="Das Lehrgangsskript Termin 1 von Karsten Melzer (April 2026, Rechtsstand 2025) im Wortlaut, die Übersichten als Tabellen und die Schaubilder als Tabellen in Lesereihenfolge. Eingepflegt sind Kapitel 1 (Maßgeblichkeitsgrundsatz), Kapitel 2 (Klausuraufbau: Ansatz dem Grunde nach, Bewertung, Übersichten Handelsbilanz/Steuerbilanz) und Kapitel 3 (Ansatz dem Grunde nach: Wirtschaftsgut, Zurechnung mit Mietkauf und Leasing, Zuordnung, Gebäudeteile und Betriebsvorrichtungen, Mietereinbauten, Gebäude auf fremdem Grund und Boden, Erbbaurecht). Die Kapitel 4 bis 16 – von der Bewertung über Anlage- und Umlaufvermögen, Rückstellungen und latente Steuern bis zur Bilanzberichtigung – folgen."
