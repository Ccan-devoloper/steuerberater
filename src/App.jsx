      ...
      <main className="page">
        ...
        {ansicht === "skript-melzer" && (
          <KurzskriptBloecke
            ...
            lead="Das Lehrgangsskript Termin 1 von Karsten Melzer (April 2026, Rechtsstand 2025) im Wortlaut, die Übersichten als Tabellen und die Schaubilder als Tabellen in Lesereihenfolge. Vollständig eingepflegt – alle 16 Kapitel: Maßgeblichkeitsgrundsatz und Klausuraufbau; Ansatz dem Grunde nach (Wirtschaftsgut, Zurechnung mit Mietkauf und Leasing, Zuordnung, Gebäudeteile, Mietereinbauten, Erbbaurecht); Bewertung (Anschaffungs- und Herstellungskosten, Teilwert, Einlagen und Entnahmen, Kfz, Teilwertabschreibung); abnutzbares und nicht abnutzbares Anlagevermögen; Umlaufvermögen; Forderungen; Rechnungsabgrenzung; Verbindlichkeiten mit § 4 Abs. 4a EStG; Sonderposten mit Rücklageanteil; Rückstellungen; Schuldübernahme; Bewertungseinheiten; latente Steuern; Bilanzberichtigung und Bilanzänderung mit Mehr- und Weniger-Rechnung. Dazu im Anhang vollständig die Übersichten zum Skript, alle 27 Abschnitte (Klausuraufbau, immaterielle Wirtschaftsgüter, Rechnungsabgrenzung, Mietkauf und Leasing, Einlagen und Entnahmen, Anschaffungs- und Herstellungskosten, Abschreibung und AfA, Umlaufvermögen, Forderungen, Verbindlichkeiten, Fremdwährung, Bewertungseinheiten, Gebäude, Mietereinbauten, Gebäude auf fremdem Grund und Boden, Erbbaurecht, Abbruchkosten, anschaffungsnaher Herstellungsaufwand, Entstrickung und Verstrickung, Beteiligungen an Kapitalgesellschaften, § 6b EStG, R 6.6 EStR und Zuschüsse, Kapitalerhöhung, Bilanzberichtigung, Rückstellungen, latente Steuern, Schuldübernahme)."
